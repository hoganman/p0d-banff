...
public:
  ...
  // Const, i.e. do not allow to modify the FV
  virtual Bool_t InVOI(SubDetId_h det, const Float_t* pos) const;
  virtual Bool_t InVOI1(const Float_t* pos) const;
  virtual Bool_t InVOI2(const Float_t* pos) const;
  virtual Bool_t InVOIext(const Float_t* pos) const;
 
  // Checks whether should look for the interaction type of this particle
  virtual Bool_t CheckLookForInteraction(SubDetId_h det, const AnaTrueParticleB& particle) const;
