...
GeometryManager::GeometryManager(){
  ...
  _useDefaultGeometry = ND::params().GetParameterD("psycheND280Utils.Geometry.UseDefaultGeometry");
  _currentGeomID=-1;
...
bool GeometryManager::LoadGeometry(const std::string& file_name0, Int_t geomID, const std::string& geomDir0) {
  ...
  */
  ...
  if (ND::params().GetParameterI("psycheND280Utils.Geometry.DetectorDefinitionFromROOTGeometry"))
...
void GeometryManager::InitializeDetectorDefinitionFromROOTGeometry() const {
  ...
  if (ND::params().GetParameterI("psycheND280Utils.Geometry.DetectorDefinitionFromROOTGeometry.FillFGDInfo"))
...
bool GeometryManager::VisitNode(const std::string& name, const TGeoNode* node) const {
  ...
  if (name.find("P0D_") != std::string::npos
    ...
    UpdateVolumeBound(DetDef::p0dmin, DetDef::p0dmax, low, high);
    return false;
  }
  ...
  if (name.find("TPC1")     != std::string::npos
    ...
    UpdateVolumeBound(DetDef::tpc1min, DetDef::tpc1max, low, high);
    return false;
  }
  if (name.find("TPC2")     != std::string::npos
     // && name.find("Drift") != std::string::npos) {
    ){
    UpdateVolumeBound(DetDef::tpc2min, DetDef::tpc2max, low, high);
    return false;
  }
  if (name.find("TPC3")     != std::string::npos
   //   && name.find("Drift") != std::string::npos) {
  ){
    UpdateVolumeBound(DetDef::tpc3min, DetDef::tpc3max, low, high);
    return false;
  }
  ...
  // Top and Bottom
  if (name.find("LeftClam_")   != std::string::npos
      && (  name.find("0_pv")               != std::string::npos
        ||  name.find("FluxReturn_pv_0_")   != std::string::npos)) {
    UpdateVolumeBound(DetDef::smrdBLmin, DetDef::smrdBLmax, low, high);
    return false;
  }

  if (name.find("LeftClam_")    != std::string::npos
      && (  name.find("6_pv")                 != std::string::npos
        ||  name.find("FluxReturn_pv_170_0")  != std::string::npos)) {
    UpdateVolumeBound(DetDef::smrdTLmin, DetDef::smrdTLmax, low, high);
    return false;
  }
  ...
  if (name.find("RightClam_")   != std::string::npos
      && (  name.find("0_pv")               != std::string::npos
        ||  name.find("FluxReturn_pv_0_")   != std::string::npos)) {
    UpdateVolumeBound(DetDef::smrdTRmin, DetDef::smrdTRmax, low, high);
    return false;
  }
  ...
  if (name.find("RightClam_")    != std::string::npos
      && (  name.find("6_pv")                 != std::string::npos
        ||  name.find("FluxReturn_pv_170_0")  != std::string::npos)) {
    UpdateVolumeBound(DetDef::smrdBRmin, DetDef::smrdBRmax, low, high);
    return false;
  }
  ...
  // three layers
  if (name.find("LeftClam_")    != std::string::npos
      && (  name.find("MRDSide:4")            != std::string::npos
        ||  name.find("FluxReturn_pv_67_0")   != std::string::npos)) {
    UpdateVolumeBound(DetDef::smrd15Lmin, DetDef::smrd15Lmax, low, high);
    return false;
  }
  //four layers
  if (name.find("LeftClam_")    != std::string::npos
      && (  name.find("MRDSide:5")            != std::string::npos
        ||  name.find("FluxReturn_pv_67_5")   != std::string::npos)) {
    UpdateVolumeBound(DetDef::smrd6Lmin, DetDef::smrd6Lmax, low, high);
    return false;
  }
  //6 layers
  if (name.find("LeftClam_")    != std::string::npos
      && (  name.find("MRDSide:7")            != std::string::npos
        ||  name.find("FluxReturn_pv_67_6")   != std::string::npos)) {
    UpdateVolumeBound(DetDef::smrd78Lmin, DetDef::smrd78Lmax, low, high);
    return false;
  }
  ...
  if (name.find("RightClam_")    != std::string::npos
      && (  name.find("MRDSide:4")            != std::string::npos
        ||  name.find("FluxReturn_pv_67_0")   != std::string::npos)) {
    UpdateVolumeBound(DetDef::smrd15Rmin, DetDef::smrd15Rmax, low, high);
    return false;
  }
  //four layers
  if (name.find("RightClam_")    != std::string::npos
      && (  name.find("MRDSide:5")            != std::string::npos
        ||  name.find("FluxReturn_pv_67_5")   != std::string::npos)) {
    UpdateVolumeBound(DetDef::smrd6Rmin, DetDef::smrd6Rmax, low, high);
    return false;
  }
  //6 layers
  if (name.find("RightClam_")    != std::string::npos
      && (  name.find("MRDSide:7")            != std::string::npos
        ||  name.find("FluxReturn_pv_67_6")   != std::string::npos)) {
    UpdateVolumeBound(DetDef::smrd78Rmin, DetDef::smrd78Rmax, low, high);
    return false;
  }
...
void GeometryManager::ResetVolumeDefinitions() const {
  ...
  //TPC1
  SetDetectorBoundaries(DetDef::tpc1min,      DetDef::tpc1max,    min, max); 

  //TPC2
  SetDetectorBoundaries(DetDef::tpc2min,      DetDef::tpc2max,    min, max); 

  //TPC3
  SetDetectorBoundaries(DetDef::tpc3min,      DetDef::tpc3max,    min, max);

  //P0D
  SetDetectorBoundaries(DetDef::p0dmin,       DetDef::p0dmax,     min, max);
  ...
  //SMRD
  SetDetectorBoundaries(DetDef::smrdTLmin,   DetDef::smrdTLmax,  min, max);
  SetDetectorBoundaries(DetDef::smrdTRmin,   DetDef::smrdTRmax,  min, max);

  SetDetectorBoundaries(DetDef::smrdBLmin,   DetDef::smrdBLmax,  min, max);
  SetDetectorBoundaries(DetDef::smrdBRmin,   DetDef::smrdBRmax,  min, max);


  SetDetectorBoundaries(DetDef::smrd15Lmin,   DetDef::smrd15Lmax,   min, max);
  SetDetectorBoundaries(DetDef::smrd15Rmin,   DetDef::smrd15Rmax,   min, max);

  SetDetectorBoundaries(DetDef::smrd6Lmin,    DetDef::smrd6Lmax,    min, max);
  SetDetectorBoundaries(DetDef::smrd6Rmin,    DetDef::smrd6Rmax,    min, max);

  SetDetectorBoundaries(DetDef::smrd78Lmin,   DetDef::smrd78Lmax,   min, max);
  SetDetectorBoundaries(DetDef::smrd78Rmin,   DetDef::smrd78Rmax,   min, max);
