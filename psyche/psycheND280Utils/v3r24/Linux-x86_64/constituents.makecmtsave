...
ifdef READONLY
cmt_local_tagfile = /tmp/CMT_$(psycheND280Utils_tag).make$(cmt_lock_pid)
else
#cmt_local_tagfile = $(psycheND280Utils_tag).make
cmt_local_tagfile = $(bin)$(psycheND280Utils_tag).make
endif
...
ifdef READONLY
cmt_local_setup = /tmp/CMT_psycheND280Utilssetup$(cmt_lock_pid).make
cmt_final_setup = /tmp/CMT_psycheND280Utilssetup.make
else
#cmt_local_setup = $(bin)psycheND280Utilssetup$(cmt_lock_pid).make
...
ifdef READONLY
cmt_local_tagfile_doxygen = /tmp/CMT_$(psycheND280Utils_tag)_doxygen.make$(cmt_lock_pid)
cmt_final_setup_doxygen = /tmp/CMT_psycheND280Utils_doxygensetup.make
cmt_local_doxygen_makefile = /tmp/CMT_doxygen$(cmt_lock_pid).make
else
#cmt_local_tagfile_doxygen = $(psycheND280Utils_tag)_doxygen.make
cmt_local_tagfile_doxygen = $(bin)$(psycheND280Utils_tag)_doxygen.make
cmt_final_setup_doxygen = $(bin)psycheND280Utils_doxygensetup.make
...
ifdef READONLY
cmt_local_tagfile_doxygen = /tmp/CMT_$(psycheND280Utils_tag).make$(cmt_lock_pid)
cmt_final_setup_doxygen = /tmp/CMT_psycheND280Utilssetup.make
cmt_local_doxygen_makefile = /tmp/CMT_doxygen$(cmt_lock_pid).make
else
#cmt_local_tagfile_doxygen = $(psycheND280Utils_tag).make
cmt_local_tagfile_doxygen = $(bin)$(psycheND280Utils_tag).make
cmt_final_setup_doxygen = $(bin)psycheND280Utilssetup.make
cmt_local_doxygen_makefile = $(bin)doxygen.make
endif
...
ifdef READONLY
cmt_local_tagfile_dictionary = /tmp/CMT_$(psycheND280Utils_tag)_dictionary.make$(cmt_lock_pid)
cmt_final_setup_dictionary = /tmp/CMT_psycheND280Utils_dictionarysetup.make
cmt_local_dictionary_makefile = /tmp/CMT_dictionary$(cmt_lock_pid).make
else
#cmt_local_tagfile_dictionary = $(psycheND280Utils_tag)_dictionary.make
cmt_local_tagfile_dictionary = $(bin)$(psycheND280Utils_tag)_dictionary.make
cmt_final_setup_dictionary = $(bin)psycheND280Utils_dictionarysetup.make
...
ifdef READONLY
cmt_local_tagfile_dictionary = /tmp/CMT_$(psycheND280Utils_tag).make$(cmt_lock_pid)
cmt_final_setup_dictionary = /tmp/CMT_psycheND280Utilssetup.make
cmt_local_dictionary_makefile = /tmp/CMT_dictionary$(cmt_lock_pid).make
else
#cmt_local_tagfile_dictionary = $(psycheND280Utils_tag).make
cmt_local_tagfile_dictionary = $(bin)$(psycheND280Utils_tag).make
cmt_final_setup_dictionary = $(bin)psycheND280Utilssetup.make
cmt_local_dictionary_makefile = $(bin)dictionary.make
endif
...
psycheND280Utils_extratags = -tag_add=target_psycheND280Utils

#$(cmt_local_tagfile_psycheND280Utils) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_psycheND280Utils) ::
else
$(cmt_local_tagfile_psycheND280Utils) :
endif
	$(echo) "(constituents.make) Rebuilding setup.make $(cmt_local_tagfile_psycheND280Utils)"
	@if test -f $(cmt_local_tagfile_psycheND280Utils); then /bin/rm -f $(cmt_local_tagfile_psycheND280Utils); fi ; \
	  $(cmtexe) -tag=$(tags) $(psycheND280Utils_extratags) build tag_makefile >>$(cmt_local_tagfile_psycheND280Utils); \
	  if test -f $(cmt_final_setup_psycheND280Utils); then /bin/rm -f $(cmt_final_setup_psycheND280Utils); fi; \
	  $(cmtexe) -tag=$(tags) $(psycheND280Utils_extratags) show setup >>$(cmt_final_setup_psycheND280Utils)
	$(echo) setup.make ok
...
ifndef QUICK
$(cmt_local_psycheND280Utils_makefile) :: $(psycheND280Utils_dependencies) $(cmt_local_tagfile_psycheND280Utils) build_library_links dirs
else
$(cmt_local_psycheND280Utils_makefile) :: $(cmt_local_tagfile_psycheND280Utils)
endif
	$(echo) "(constituents.make) Building psycheND280Utils.make"; \
	  $(cmtexe) -tag=$(tags) $(psycheND280Utils_extratags) build constituent_makefile -out=$(cmt_local_psycheND280Utils_makefile) psycheND280Utils

psycheND280Utils :: $(psycheND280Utils_dependencies) $(cmt_local_psycheND280Utils_makefile)
	$(echo) "(constituents.make) Starting psycheND280Utils"
	@$(MAKE) -f $(cmt_local_psycheND280Utils_makefile) cmt_lock_pid=$${cmt_lock_pid} psycheND280Utils
	$(echo) "(constituents.make) psycheND280Utils done"

clean :: psycheND280Utilsclean

psycheND280Utilsclean :: $(psycheND280Utilsclean_dependencies) ##$(cmt_local_psycheND280Utils_makefile)
	$(echo) "(constituents.make) Starting psycheND280Utilsclean"
	@-if test -f $(cmt_local_psycheND280Utils_makefile); then \
	  $(MAKE) -f $(cmt_local_psycheND280Utils_makefile) cmt_lock_pid=$${cmt_lock_pid} psycheND280Utilsclean; \
	fi

##	  /bin/rm -f $(cmt_local_psycheND280Utils_makefile) $(bin)psycheND280Utils_dependencies.make

install :: psycheND280Utilsinstall

psycheND280Utilsinstall :: $(psycheND280Utils_dependencies) $(cmt_local_psycheND280Utils_makefile)
	$(echo) "(constituents.make) Starting install psycheND280Utils"
	@-$(MAKE) -f $(cmt_local_psycheND280Utils_makefile) cmt_lock_pid=$${cmt_lock_pid} install
	$(echo) "(constituents.make) install psycheND280Utils done"

uninstall :: psycheND280Utilsuninstall

psycheND280Utilsuninstall :: $(cmt_local_psycheND280Utils_makefile)
	$(echo) "(constituents.make) Starting uninstall psycheND280Utils"
	@-$(MAKE) -f $(cmt_local_psycheND280Utils_makefile) cmt_lock_pid=$${cmt_lock_pid} uninstall
	$(echo) "(constituents.make) uninstall psycheND280Utils done"
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(psycheND280Utils_tag)_make.make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_psycheND280Utils_makesetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(psycheND280Utils_tag)_make.make
cmt_local_tagfile_make = $(bin)$(psycheND280Utils_tag)_make.make
cmt_final_setup_make = $(bin)psycheND280Utils_makesetup.make
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(psycheND280Utils_tag).make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_psycheND280Utilssetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(psycheND280Utils_tag).make
cmt_local_tagfile_make = $(bin)$(psycheND280Utils_tag).make
cmt_final_setup_make = $(bin)psycheND280Utilssetup.make
cmt_local_make_makefile = $(bin)make.make
endif
