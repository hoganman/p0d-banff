...
dictionary :: $(filter %_LinkDef.rootcint,$(dictionary_output)psycheND280Tools_LinkDef.rootcint)
	@echo "------> dictionary ok"

psycheND280Tools_LinkDef_h_dependencies = ../src/psycheND280Tools_LinkDef.h
# -*- makefile -*-
# 
# A makefile fragment used by CMT to build the ROOT dictionary files.
#

$(dict)psycheND280Tools_LinkDef.rootcint : $(dict)$(patsubst %_LinkDef,%_Dict,psycheND280Tools_LinkDef).cxx
	@touch $@

$(dict)$(patsubst %_LinkDef,%_Dict,psycheND280Tools_LinkDef).cxx : \
    $(patsubst %_LinkDef.h,%.h*,$(src)psycheND280Tools_LinkDef.h) \
    $(src)psycheND280Tools_LinkDef.h  $(ROOT_stamps)
