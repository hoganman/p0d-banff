...
//********************************************************************
nueP0DPileUpSystematics::nueP0DPileUpSystematics():EventWeightBase(1){
//********************************************************************

  _fgd1 = new BinnedParams("nueFGD1_P0D_PileUp",BinnedParams::k1D_SYMMETRIC);
  _fgd2 = new BinnedParams("nueFGD2_P0D_PileUp",BinnedParams::k1D_SYMMETRIC);
  SetNParameters(_fgd1->GetNBins()+_fgd2->GetNBins());
}

//********************************************************************
void nueP0DPileUpSystematics::Initialize(){
//********************************************************************
...
//********************************************************************
Weight_h nueP0DPileUpSystematics::ComputeWeight(const ToyExperiment& toy, const AnaEventC& eventBB, const ToyBoxB& box){
//********************************************************************
