...
tag=Linux-x86_64
package=psycheSystematics
version=v3r24
PACKAGE_ROOT=$(PSYCHESYSTEMATICSROOT)
srcdir=../src
bin=../$(psycheSystematics_tag)/
BIN=/physics/home/mhogan/software/t2k-software-clone/psyche/psycheSystematics/v3r24/$(psycheSystematics_tag)/
javabin=../classes/
mgrdir=cmt
project=software
cmt_installarea_paths= $(cmt_installarea_prefix)/$(CMTCONFIG)/bin
use_linkopts= $(cmt_installarea_linkopts)   $(psycheSystematics_linkopts)  $(psycheSelections_linkopts)  $(psycheIO_linkopts)  $(psycheND280Utils_linkopts)  $(psycheUtils_linkopts)  $(psycheEventModel_linkopts)  $(psycheCore_linkopts)  $(psychePolicy_linkopts)  $(ROOT_linkopts)  $(MYSQL_linkopts)  $(GSL_linkopts)  $(EXTERN_linkopts) 
...
use_requirements=requirements $(CMTROOT)/mgr/requirements $(PSYCHESELECTIONSROOT)/cmt/requirements $(PSYCHEIOROOT)/cmt/requirements $(PSYCHEND280UTILSROOT)/cmt/requirements $(PSYCHEUTILSROOT)/cmt/requirements $(PSYCHEEVENTMODELROOT)/cmt/requirements $(PSYCHECOREROOT)/cmt/requirements $(PSYCHEPOLICYROOT)/cmt/requirements $(ROOTROOT)/cmt/requirements $(MYSQLROOT)/cmt/requirements $(GSLROOT)/cmt/requirements $(EXTERNROOT)/cmt/requirements 
use_includes= $(ppcmd)"$(psycheSelections_root)/src" $(ppcmd)"$(psycheIO_root)/src" $(ppcmd)"$(psycheND280Utils_root)/src" $(ppcmd)"$(psycheUtils_root)/src" $(ppcmd)"$(psycheEventModel_root)/src" $(ppcmd)"$(psycheCore_root)/src" $(ppcmd)"$(psychePolicy_root)/src" $(ppcmd)"/physics/software/t2k/ND280/v11r31/ROOT/v5r34p09n04/Linux-x86_64/include/root" $(ppcmd)"none" $(ppcmd)"/physics/software/t2k/ND280/v11r31/MYSQL/v5r051an01/Linux-x86_64/include/mysql" $(ppcmd)"/physics/software/t2k/ND280/v11r31/GSL/v1r15p0n00/Linux-x86_64/include" $(ppcmd)"$(EXTERN_root)/src" 
use_fincludes= $(use_includes)
use_stamps= $(psycheSystematics_stamps)  $(psycheSelections_stamps)  $(psycheIO_stamps)  $(psycheND280Utils_stamps)  $(psycheUtils_stamps)  $(psycheEventModel_stamps)  $(psycheCore_stamps)  $(psychePolicy_stamps)  $(ROOT_stamps)  $(MYSQL_stamps)  $(GSL_stamps)  $(EXTERN_stamps) 
use_cflags=  $(psycheSystematics_cflags)  $(psycheSelections_cflags)  $(psycheIO_cflags)  $(psycheND280Utils_cflags)  $(psycheUtils_cflags)  $(psycheEventModel_cflags)  $(psycheCore_cflags)  $(psychePolicy_cflags)  $(ROOT_cflags)  $(MYSQL_cflags)  $(GSL_cflags)  $(EXTERN_cflags) 
use_pp_cflags=  $(psycheSystematics_pp_cflags)  $(psycheSelections_pp_cflags)  $(psycheIO_pp_cflags)  $(psycheND280Utils_pp_cflags)  $(psycheUtils_pp_cflags)  $(psycheEventModel_pp_cflags)  $(psycheCore_pp_cflags)  $(psychePolicy_pp_cflags)  $(ROOT_pp_cflags)  $(MYSQL_pp_cflags)  $(GSL_pp_cflags)  $(EXTERN_pp_cflags) 
use_cppflags=  $(psycheSystematics_cppflags)  $(psycheSelections_cppflags)  $(psycheIO_cppflags)  $(psycheND280Utils_cppflags)  $(psycheUtils_cppflags)  $(psycheEventModel_cppflags)  $(psycheCore_cppflags)  $(psychePolicy_cppflags)  $(ROOT_cppflags)  $(MYSQL_cppflags)  $(GSL_cppflags)  $(EXTERN_cppflags) 
use_pp_cppflags=  $(psycheSystematics_pp_cppflags)  $(psycheSelections_pp_cppflags)  $(psycheIO_pp_cppflags)  $(psycheND280Utils_pp_cppflags)  $(psycheUtils_pp_cppflags)  $(psycheEventModel_pp_cppflags)  $(psycheCore_pp_cppflags)  $(psychePolicy_pp_cppflags)  $(ROOT_pp_cppflags)  $(MYSQL_pp_cppflags)  $(GSL_pp_cppflags)  $(EXTERN_pp_cppflags) 
use_fflags=  $(psycheSystematics_fflags)  $(psycheSelections_fflags)  $(psycheIO_fflags)  $(psycheND280Utils_fflags)  $(psycheUtils_fflags)  $(psycheEventModel_fflags)  $(psycheCore_fflags)  $(psychePolicy_fflags)  $(ROOT_fflags)  $(MYSQL_fflags)  $(GSL_fflags)  $(EXTERN_fflags) 
use_pp_fflags=  $(psycheSystematics_pp_fflags)  $(psycheSelections_pp_fflags)  $(psycheIO_pp_fflags)  $(psycheND280Utils_pp_fflags)  $(psycheUtils_pp_fflags)  $(psycheEventModel_pp_fflags)  $(psycheCore_pp_fflags)  $(psychePolicy_pp_fflags)  $(ROOT_pp_fflags)  $(MYSQL_pp_fflags)  $(GSL_pp_fflags)  $(EXTERN_pp_fflags) 
use_libraries= $(psycheSelections_libraries)  $(psycheIO_libraries)  $(psycheND280Utils_libraries)  $(psycheUtils_libraries)  $(psycheEventModel_libraries)  $(psycheCore_libraries)  $(psychePolicy_libraries)  $(ROOT_libraries)  $(MYSQL_libraries)  $(GSL_libraries)  $(EXTERN_libraries) 
includes= $(ppcmd)"$(srcdir)" $(use_includes)
fincludes= $(includes)
psycheSystematics_use_linkopts=  $(psycheSystematics_linkopts)  $(psycheSelections_linkopts)  $(psycheIO_linkopts)  $(psycheND280Utils_linkopts)  $(psycheUtils_linkopts)  $(psycheEventModel_linkopts)  $(psycheCore_linkopts)  $(psychePolicy_linkopts)  $(ROOT_linkopts)  $(MYSQL_linkopts)  $(GSL_linkopts)  $(EXTERN_linkopts) 
constituents= dictionary psycheSystematics 
all_constituents= $(constituents)
constituentsclean= psycheSystematicsclean dictionaryclean 
