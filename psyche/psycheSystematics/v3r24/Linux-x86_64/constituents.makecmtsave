...
ifdef READONLY
cmt_local_tagfile = /tmp/CMT_$(psycheSystematics_tag).make$(cmt_lock_pid)
else
#cmt_local_tagfile = $(psycheSystematics_tag).make
cmt_local_tagfile = $(bin)$(psycheSystematics_tag).make
endif
...
ifdef READONLY
cmt_local_setup = /tmp/CMT_psycheSystematicssetup$(cmt_lock_pid).make
cmt_final_setup = /tmp/CMT_psycheSystematicssetup.make
else
#cmt_local_setup = $(bin)psycheSystematicssetup$(cmt_lock_pid).make
...
ifdef READONLY
cmt_local_tagfile_doxygen = /tmp/CMT_$(psycheSystematics_tag)_doxygen.make$(cmt_lock_pid)
cmt_final_setup_doxygen = /tmp/CMT_psycheSystematics_doxygensetup.make
cmt_local_doxygen_makefile = /tmp/CMT_doxygen$(cmt_lock_pid).make
else
#cmt_local_tagfile_doxygen = $(psycheSystematics_tag)_doxygen.make
cmt_local_tagfile_doxygen = $(bin)$(psycheSystematics_tag)_doxygen.make
cmt_final_setup_doxygen = $(bin)psycheSystematics_doxygensetup.make
...
ifdef READONLY
cmt_local_tagfile_doxygen = /tmp/CMT_$(psycheSystematics_tag).make$(cmt_lock_pid)
cmt_final_setup_doxygen = /tmp/CMT_psycheSystematicssetup.make
cmt_local_doxygen_makefile = /tmp/CMT_doxygen$(cmt_lock_pid).make
else
#cmt_local_tagfile_doxygen = $(psycheSystematics_tag).make
cmt_local_tagfile_doxygen = $(bin)$(psycheSystematics_tag).make
cmt_final_setup_doxygen = $(bin)psycheSystematicssetup.make
cmt_local_doxygen_makefile = $(bin)doxygen.make
endif
...
psycheSystematics_extratags = -tag_add=target_psycheSystematics

#$(cmt_local_tagfile_psycheSystematics) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_psycheSystematics) ::
else
$(cmt_local_tagfile_psycheSystematics) :
endif
	$(echo) "(constituents.make) Rebuilding setup.make $(cmt_local_tagfile_psycheSystematics)"
	@if test -f $(cmt_local_tagfile_psycheSystematics); then /bin/rm -f $(cmt_local_tagfile_psycheSystematics); fi ; \
	  $(cmtexe) -tag=$(tags) $(psycheSystematics_extratags) build tag_makefile >>$(cmt_local_tagfile_psycheSystematics); \
	  if test -f $(cmt_final_setup_psycheSystematics); then /bin/rm -f $(cmt_final_setup_psycheSystematics); fi; \
	  $(cmtexe) -tag=$(tags) $(psycheSystematics_extratags) show setup >>$(cmt_final_setup_psycheSystematics)
	$(echo) setup.make ok
...
ifndef QUICK
$(cmt_local_psycheSystematics_makefile) :: $(psycheSystematics_dependencies) $(cmt_local_tagfile_psycheSystematics) build_library_links dirs
else
$(cmt_local_psycheSystematics_makefile) :: $(cmt_local_tagfile_psycheSystematics)
endif
	$(echo) "(constituents.make) Building psycheSystematics.make"; \
	  $(cmtexe) -tag=$(tags) $(psycheSystematics_extratags) build constituent_makefile -out=$(cmt_local_psycheSystematics_makefile) psycheSystematics

psycheSystematics :: $(psycheSystematics_dependencies) $(cmt_local_psycheSystematics_makefile)
	$(echo) "(constituents.make) Starting psycheSystematics"
	@$(MAKE) -f $(cmt_local_psycheSystematics_makefile) cmt_lock_pid=$${cmt_lock_pid} psycheSystematics
	$(echo) "(constituents.make) psycheSystematics done"

clean :: psycheSystematicsclean

psycheSystematicsclean :: $(psycheSystematicsclean_dependencies) ##$(cmt_local_psycheSystematics_makefile)
	$(echo) "(constituents.make) Starting psycheSystematicsclean"
	@-if test -f $(cmt_local_psycheSystematics_makefile); then \
	  $(MAKE) -f $(cmt_local_psycheSystematics_makefile) cmt_lock_pid=$${cmt_lock_pid} psycheSystematicsclean; \
	fi

##	  /bin/rm -f $(cmt_local_psycheSystematics_makefile) $(bin)psycheSystematics_dependencies.make

install :: psycheSystematicsinstall

psycheSystematicsinstall :: $(psycheSystematics_dependencies) $(cmt_local_psycheSystematics_makefile)
	$(echo) "(constituents.make) Starting install psycheSystematics"
	@-$(MAKE) -f $(cmt_local_psycheSystematics_makefile) cmt_lock_pid=$${cmt_lock_pid} install
	$(echo) "(constituents.make) install psycheSystematics done"

uninstall :: psycheSystematicsuninstall

psycheSystematicsuninstall :: $(cmt_local_psycheSystematics_makefile)
	$(echo) "(constituents.make) Starting uninstall psycheSystematics"
	@-$(MAKE) -f $(cmt_local_psycheSystematics_makefile) cmt_lock_pid=$${cmt_lock_pid} uninstall
	$(echo) "(constituents.make) uninstall psycheSystematics done"
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(psycheSystematics_tag)_make.make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_psycheSystematics_makesetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(psycheSystematics_tag)_make.make
cmt_local_tagfile_make = $(bin)$(psycheSystematics_tag)_make.make
cmt_final_setup_make = $(bin)psycheSystematics_makesetup.make
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(psycheSystematics_tag).make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_psycheSystematicssetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(psycheSystematics_tag).make
cmt_local_tagfile_make = $(bin)$(psycheSystematics_tag).make
cmt_final_setup_make = $(bin)psycheSystematicssetup.make
cmt_local_make_makefile = $(bin)make.make
endif
