...
${CMTROOT}/mgr/cmt setup -sh -pack=psycheSystematics -version=v3r24 -path=/physics/home/mhogan/software/t2k-software-clone/psyche  -no_cleanup $* >${tempfile}; . ${tempfile}
/bin/rm -f ${tempfile}
