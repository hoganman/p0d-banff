...
public:
  ...
  virtual void InitializeSystBoxes(Int_t nsel, Int_t isel, Int_t nbranch, Int_t nevents);
  
  /// A method that may be used for some systematic if needed
  /// Is called by the SystematicManager after a systematic gets its
  /// index
  /// By default is empty
