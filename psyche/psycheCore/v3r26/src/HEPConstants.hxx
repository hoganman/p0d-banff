////////////////////////////////////////////////////////////
// $Id: HEPConstants.hxx,v 1.6 2018/01/19 14:46:41 izmaylov Exp $
//
...
namespace units {
    ...
    *classic_electr_radius;
    ...
    extern const double mass_sigma_plus;
    extern const double mass_sigma_minus;
    extern const double mass_sigma_zero;
 
    // Get the ROOT PDG instance
