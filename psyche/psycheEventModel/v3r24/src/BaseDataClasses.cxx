...
//********************************************************************
  ...
  Float_t m1 = -3e6;
  Float_t m2 = -3e6;
  if (t1 != NULL) m1 = t1->RangeMomentumMuon;
  if (t2 != NULL) m2 = t2->RangeMomentumMuon;
...
//********************************************************************
bool AnaTrueParticleB::CompareMomentum(const AnaTrueParticleB* t1, const AnaTrueParticleB* t2){
//********************************************************************
    // function to sort particles in decreasing momentum order
    // set null pointer to be sorted the very last.
    Float_t m1 = -3e6;
