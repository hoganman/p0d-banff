...
ifdef READONLY
cmt_local_tagfile = /tmp/CMT_$(psychePolicy_tag).make$(cmt_lock_pid)
else
#cmt_local_tagfile = $(psychePolicy_tag).make
cmt_local_tagfile = $(bin)$(psychePolicy_tag).make
endif
...
ifdef READONLY
cmt_local_setup = /tmp/CMT_psychePolicysetup$(cmt_lock_pid).make
cmt_final_setup = /tmp/CMT_psychePolicysetup.make
else
#cmt_local_setup = $(bin)psychePolicysetup$(cmt_lock_pid).make
cmt_local_setup = $(bin)$(package)setup$$$$.make
#cmt_final_setup = $(bin)psychePolicysetup.make
...
ifdef READONLY
cmt_local_tagfile_doxygen = /tmp/CMT_$(psychePolicy_tag)_doxygen.make$(cmt_lock_pid)
cmt_final_setup_doxygen = /tmp/CMT_psychePolicy_doxygensetup.make
cmt_local_doxygen_makefile = /tmp/CMT_doxygen$(cmt_lock_pid).make
else
#cmt_local_tagfile_doxygen = $(psychePolicy_tag)_doxygen.make
cmt_local_tagfile_doxygen = $(bin)$(psychePolicy_tag)_doxygen.make
cmt_final_setup_doxygen = $(bin)psychePolicy_doxygensetup.make
...
ifdef READONLY
cmt_local_tagfile_doxygen = /tmp/CMT_$(psychePolicy_tag).make$(cmt_lock_pid)
cmt_final_setup_doxygen = /tmp/CMT_psychePolicysetup.make
cmt_local_doxygen_makefile = /tmp/CMT_doxygen$(cmt_lock_pid).make
else
#cmt_local_tagfile_doxygen = $(psychePolicy_tag).make
cmt_local_tagfile_doxygen = $(bin)$(psychePolicy_tag).make
cmt_final_setup_doxygen = $(bin)psychePolicysetup.make
cmt_local_doxygen_makefile = $(bin)doxygen.make
endif
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(psychePolicy_tag)_make.make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_psychePolicy_makesetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(psychePolicy_tag)_make.make
cmt_local_tagfile_make = $(bin)$(psychePolicy_tag)_make.make
cmt_final_setup_make = $(bin)psychePolicy_makesetup.make
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(psychePolicy_tag).make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_psychePolicysetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(psychePolicy_tag).make
cmt_local_tagfile_make = $(bin)$(psychePolicy_tag).make
cmt_final_setup_make = $(bin)psychePolicysetup.make
cmt_local_make_makefile = $(bin)make.make
endif
