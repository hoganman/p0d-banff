...
public:
  ...
  /// Getting the index
  Int_t GetBinnedParamsIndex() const{
    return _indexBinnedParams;
  }

  /// Setting the index
  void SetBinnedParamsIndex(Int_t index){
    _indexBinnedParams = index;
  }
...
private:
  ...
  /// index,  this is to be able to register a particular binned param inside
  /// the code that uses it
  Int_t _indexBinnedParams;
