#define P0DWATERNUMUBKGINANTINUMODECCMULTITRACKSELECTION_CXX
...
//********************************************************************
p0dWaterNumuBkgInAntiNuModeCCMultiTrackSelection::p0dWaterNumuBkgInAntiNuModeCCMultiTrackSelection(bool forceBreak):
...
//********************************************************************
void p0dWaterNumuBkgInAntiNuModeCCMultiTrackSelection::DefineSteps(){
//********************************************************************
    ...
    AddStep(StepBase::kAction, "fill_summary",        new FillSummaryAction_p0dWaterNumuBkgInAntiNuModeCCMultiTrack());
...
//**************************************************
void p0dWaterNumuBkgInAntiNuModeCCMultiTrackSelection::InitializeEvent(AnaEventC& eventC){
//**************************************************
...
//********************************************************************
void p0dWaterNumuBkgInAntiNuModeCCMultiTrackSelection::DefineDetectorFV(){
//********************************************************************
...
//********************************************************************
bool p0dWaterNumuBkgInAntiNuModeCCMultiTrackSelection::FillEventSummary(AnaEventC& event, Int_t allCutsPassed[]){
//********************************************************************
...
//**************************************************
Int_t p0dWaterNumuBkgInAntiNuModeCCMultiTrackSelection::GetRelevantRecObjectGroupsForSystematic(SystId_h systId, Int_t* IDs, Int_t branch) const{
//**************************************************
...
//**************************************************
Int_t p0dWaterNumuBkgInAntiNuModeCCMultiTrackSelection::GetRelevantTrueObjectGroupsForSystematic(SystId_h systId, Int_t* IDs, Int_t branch) const{
//**************************************************
...
//********************************************************************
bool FillSummaryAction_p0dWaterNumuBkgInAntiNuModeCCMultiTrack::Apply(AnaEventC& event, ToyBoxB& boxB) const{
//********************************************************************
    ...
    static_cast<AnaEventSummaryB*>(event.Summary)->LeptonCandidate[SampleId::kP0DWaterNuMuBkgInAntiNuModeCC1Track ] = box.HMNtrack;
    static_cast<AnaEventSummaryB*>(event.Summary)->LeptonCandidate[SampleId::kP0DWaterNuMuBkgInAntiNuModeCCNTracks] = box.HMNtrack;

    for(int i = 0; i < 4; ++i){
        static_cast<AnaEventSummaryB*>(event.Summary)->VertexPosition[SampleId::kP0DWaterNuMuBkgInAntiNuModeCC1Track ][i] = box.HMNtrack->PositionStart[i];
        static_cast<AnaEventSummaryB*>(event.Summary)->VertexPosition[SampleId::kP0DWaterNuMuBkgInAntiNuModeCCNTracks][i] = box.HMNtrack->PositionStart[i];
    }
    if(box.HMNtrack->GetTrueParticle()){
        static_cast<AnaEventSummaryB*>(event.Summary)->TrueVertex[SampleId::kP0DWaterNuMuBkgInAntiNuModeCC1Track ] = box.HMNtrack->GetTrueParticle()->TrueVertex;
        static_cast<AnaEventSummaryB*>(event.Summary)->TrueVertex[SampleId::kP0DWaterNuMuBkgInAntiNuModeCCNTracks] = box.HMNtrack->GetTrueParticle()->TrueVertex;
    }
    return true;
}
