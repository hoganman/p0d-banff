#define P0DAIRNUMUBARINANTINUMODECCSELECTION_CXX
...
//********************************************************************
p0dAirNumubarInAntiNuModeCCMultiTrackSelection::p0dAirNumubarInAntiNuModeCCMultiTrackSelection(bool forceBreak):
...
//********************************************************************
void p0dAirNumubarInAntiNuModeCCMultiTrackSelection::DefineSteps(){
//********************************************************************
    ...
    AddStep(StepBase::kAction, "fill_summary",        new FillSummaryAction_p0dAirNumubarInAntiNuModeCCMultiTrack());
...
//**************************************************
void p0dAirNumubarInAntiNuModeCCMultiTrackSelection::InitializeEvent(AnaEventC& eventC){
//**************************************************
...
//********************************************************************
void p0dAirNumubarInAntiNuModeCCMultiTrackSelection::DefineDetectorFV(){
//********************************************************************
...
//********************************************************************
bool p0dAirNumubarInAntiNuModeCCMultiTrackSelection::FillEventSummary(AnaEventC& event, Int_t allCutsPassed[]){
//********************************************************************

    //CC1Track
    if(allCutsPassed[0]){
        static_cast<AnaEventSummaryB*>(event.Summary)->EventSample = SampleId::kP0DAirNuMuBarInAntiNuModeCC1Track;
    }
    //CCNTracks
    else if (allCutsPassed[1]){
        static_cast<AnaEventSummaryB*>(event.Summary)->EventSample = SampleId::kP0DAirNuMuBarInAntiNuModeCCNTracks;
    }
...
//**************************************************
Int_t p0dAirNumubarInAntiNuModeCCMultiTrackSelection::GetRelevantRecObjectGroupsForSystematic(SystId_h systId, Int_t* IDs, Int_t branch) const{
//**************************************************
...
//**************************************************
Int_t p0dAirNumubarInAntiNuModeCCMultiTrackSelection::GetRelevantTrueObjectGroupsForSystematic(SystId_h systId, Int_t* IDs, Int_t branch) const{
//**************************************************
...
//********************************************************************
bool FillSummaryAction_p0dAirNumubarInAntiNuModeCCMultiTrack::Apply(AnaEventC& event, ToyBoxB& boxB) const{
//********************************************************************
