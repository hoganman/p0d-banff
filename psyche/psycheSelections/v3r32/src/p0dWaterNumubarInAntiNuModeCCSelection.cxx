...
//********************************************************************
p0dWaterNumubarInAntiNuModeCCSelection::p0dWaterNumubarInAntiNuModeCCSelection(bool forceBreak): SelectionBase(forceBreak, EventBoxId::kEventBoxTracker) {
//********************************************************************

}

//********************************************************************
void p0dWaterNumubarInAntiNuModeCCSelection::DefineSteps(){
//********************************************************************
    ...
    AddStep(StepBase::kAction, "fill_summary",        new FillSummaryAction_p0dWaterNumubarInAntiNuModeCC());
...
//**************************************************
void p0dWaterNumubarInAntiNuModeCCSelection::InitializeEvent(AnaEventC& eventC){
//**************************************************
...
//********************************************************************
void p0dWaterNumubarInAntiNuModeCCSelection::DefineDetectorFV(){
//********************************************************************
...
//********************************************************************
bool p0dWaterNumubarInAntiNuModeCCSelection::FillEventSummary(AnaEventC& event, Int_t allCutsPassed[]){
//********************************************************************

    if(allCutsPassed[0]){
        static_cast<AnaEventSummaryB*>(event.Summary)->EventSample = SampleId::kP0DWaterNuMuBarInAntiNuModeCC;
    }
    return (static_cast<AnaEventSummaryB*>(event.Summary)->EventSample != SampleId::kUnassigned);
}

//**************************************************
Int_t p0dWaterNumubarInAntiNuModeCCSelection::GetRelevantRecObjectGroupsForSystematic(SystId_h systId, Int_t* IDs, Int_t branch) const{
//**************************************************
...
//**************************************************
Int_t p0dWaterNumubarInAntiNuModeCCSelection::GetRelevantTrueObjectGroupsForSystematic(SystId_h systId, Int_t* IDs, Int_t branch) const{
//**************************************************
...
//********************************************************************
bool FillSummaryAction_p0dWaterNumubarInAntiNuModeCC::Apply(AnaEventC& event, ToyBoxB& boxB) const{
//********************************************************************
    ...
    static_cast<AnaEventSummaryB*>(event.Summary)->LeptonCandidate[SampleId::kP0DWaterNuMuBarInAntiNuModeCC] = box.MainTrack;
    for(int i = 0; i < 4; ++i){
        static_cast<AnaEventSummaryB*>(event.Summary)->VertexPosition[SampleId::kP0DWaterNuMuBarInAntiNuModeCC][i] = box.MainTrack->PositionStart[i];
    }
    if(box.MainTrack->GetTrueParticle()) static_cast<AnaEventSummaryB*>(event.Summary)->TrueVertex[SampleId::kP0DWaterNuMuBarInAntiNuModeCC] = box.MainTrack->GetTrueParticle()->TrueVertex;
