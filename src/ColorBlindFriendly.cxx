...
void ColorBlindColors::SetCBFColorBar(int nColors)
{
    if(nColors==5)
    {
        ...
        static Int_t FI2 = TColor::CreateGradientColorTable(nColors,
            const_cast<Double_t*>(length5), const_cast<Double_t*>(fiveColorR),
            const_cast<Double_t*>(fiveColorG), const_cast<Double_t*>(fiveColorB),
            nColorBins);
    ...
    else if(nColors==4)
    {
        ...
        static Int_t FI2 = TColor::CreateGradientColorTable(nColors,
            const_cast<Double_t*>(length4), const_cast<Double_t*>(fourColorR),
            const_cast<Double_t*>(fourColorG), const_cast<Double_t*>(fourColorB),
            nColorBins);
    ...
    {
        std::cout << "There are only 4 or 5 supported colors ";
        std::cout << "for the SetCBFColorBar function" << std::endl;
    }
}
