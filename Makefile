...
ALLCLASSES :=  HEPConstants XMLTools MakeClSampleSummary MakeClFlatTree P0DBANFFInterface BenchmarkProcess Header TotalPOT TN80POT AnalysisBins Samples SampleId
