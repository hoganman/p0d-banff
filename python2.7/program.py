...
class program(p0dbanff.p0dbanff):
    ...
    def __init__(self, prog_name):
        ...
        self.descpt = 'This is the description string'
    ...
    def get_help_opt(self):
        """return the help option"""
        return self.get_option('help')
...
class RunCreateFlatTree(program):
    ...
    def __init__(self):
        ...
        self.add_option('v', '',
                        'Do not check oaAnalysis version (default ENABLE)',
                        True)
...
class ROOTprog(program):
    ...
    def __init__(self):
        super(ROOTprog, self).__init__('root')
...
class PYTHONprog(program):
    ...
    def __init__(self):
        super(PYTHONprog, self).__init__('python')
