...
//    dial_graphs.push_back(coh_bs_graph);
    ...
    for(int i=0; i<5; i++) rpa_vec.push_back( ((double)i-2.)/2. );
    ...
    if(fNEvts < 0) fNEvts = nentries; 
    std::cout << " We will process " << fNEvts << " events." << std::endl;
    ...
    for(int q = 0; q < fNEvts; ++q){
        ...
        if(!data){
            ...
            SelectedSample = event->Summary->EventSample;
