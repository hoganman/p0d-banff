...
//    dial_graphs.push_back(coh_bs_graph);
    ...
    Double_t Enu[SampleId::kNSamples],Pmu[SampleId::kNSamples],CosThetamu[SampleId::kNSamples],FluxWeight[SampleId::kNSamples],TruePmu[SampleId::kNSamples],TrueCosThetamu[SampleId::kNSamples],Q2[SampleId::kNSamples],Q2QE[SampleId::kNSamples],CCQETuningWeight[SampleId::kNSamples], MaQETuningWeight[SampleId::kNSamples], MECOTuningWeight[SampleId::kNSamples], MECCTuningWeight[SampleId::kNSamples], pFTuningWeight[SampleId::kNSamples], RFGTuningWeight[SampleId::kNSamples], RelRPATuningWeight[SampleId::kNSamples], NonRelRPATuningWeight[SampleId::kNSamples], CohTuningWeight[SampleId::kNSamples];
    Int_t NeutrinoCode[SampleId::kNSamples],ReactionCode[SampleId::kNSamples],TgtMat[SampleId::kNSamples],NuParent[SampleId::kNSamples],Run,TruthVtx[SampleId::kNSamples];
       ...
       // Get the event to be modified. This is the only one used in the analysis
		...
		if(summary->TrueVertex[sample] != NULL && summary->EventSample == sample){
                ...
                if(!vtx || Run==-1){
                    ...
                    FluxWeight[sample] = fluxWeightSyst.Systematic;
