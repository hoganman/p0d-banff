...
int main(int argc, char** argv){
    ...
    if(ND::params().GetParameterI("BANFF.RunFit.LoadObsNormParams")){
        fitParameters->LoadObsNormParametersFromFile(((ND::params().GetParameterS("BANFF.ObsNormInputFile"))), 7, samples, ND::params().GetParameterI("BANFF.RunFit.FitObsNormParams"));
    }
    ...
    //would never be done.
    psycheInterface* interface = new psycheInterface(7, samples, fitParameters, false, false);
