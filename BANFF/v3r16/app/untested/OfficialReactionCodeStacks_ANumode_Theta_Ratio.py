...
dummyPage = TCanvas()
dummyPage.Print("reactionCodeStacksOfficial_Joint2016_anumode_postfit_costheta.pdf[")
...
for ii in xrange(0,len(sampleNames)):
    ...
    for ibx in xrange(1, dataMomProj.GetNbinsX() + 1):
        ...
        print "Data = "+str(dataMomProj.GetBinContent(ibx))+"  MC = "+str(postfitMomProj.GetBinContent(ibx))+" Ratio = "+str(dataMomProj.GetBinContent(ibx)/prefitMomProj.GetBinContent(ibx))
...
#        prelim.Draw("")
        ...
        c1.Modified()
        c1.Update()
        c1.Print("reactionCodeStacksOfficial_Joint2016_anumode_postfit_costheta.pdf")
