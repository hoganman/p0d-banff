...
dummyPage = TCanvas()
dummyPage.Print("reactionCodeStacksOfficial_Joint2016_numode_postfit_costheta.pdf[")
...
for ii in xrange(0,len(sampleNames)):
    ...
    prefitMomProj = dataFile.Get(sampleName + "_prefit").Projection(1,0).ProjectionY("prefitratio" + sampleName + "_px",1,dataHist.GetNbinsX())
    prefitMomProj.SetDirectory(0)

    postfitMomProj = dataFile.Get(sampleName + "_postfit_0_0").Projection(1,0).ProjectionY("postfitratio" + sampleName + "_px",1,dataHist.GetNbinsX())
...
#        prelim.Draw("")
        ...
        c1.Modified()
        c1.Update()
        c1.Print("reactionCodeStacksOfficial_Joint2016_numode_postfit_costheta.pdf")
