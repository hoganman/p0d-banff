...
for RUN in "run2-air" "run2-water" "run3b-air" "run3c-air" "run4-air" "run4-water" "run5c-water" "run6b-air" "run6c-air" "run6d-air" "run6e-air" "run7b-water" "run8-air" "run8-water"; do
