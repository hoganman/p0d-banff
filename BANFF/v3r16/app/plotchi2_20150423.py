...
filelist2 = glob.glob("/home/myslik/data/FinalToyFits_20150410/*.root")

outFile = TFile("chi2File_400Toys_20150422_withdata.root","RECREATE")

#Create the PDF output file.
c1 = TCanvas()
c1.Print("chi2File_400Toys_20150422_withdata.pdf[")
...
#    outHists2[i].SetLineColor(kMagenta)
#    outHists2[i].Draw()
