...
int main(int argc, char** argv) {
    ...
    TFile* inputFile = new TFile("/mnt/home/morri631/BANFF_Summer2018_Analysis/software/BANFF/v3r16/pbs/outputs/02May18/asimovFit_PostFitAllParams_02May18.root");
    ...
    int norm = -1;
    int xsec = -1;
    for (int index=0; index<params->GetEntriesFast(); index++) {
        if ((((TObjString*)(params->At(index)))->GetString()).Data() == "NDNuModeNumu0") {
            std::cout << "It's the flux parameter!" <<std::endl;
        }
        else if ((((TObjString*)(params->At(index)))->GetString()).Data() == "OBSNORM_0") {
            std::cout << "It's the obsnorm parameter!" <<std::endl;
        }
        else if ((((TObjString*)(params->At(index)))->GetString()).Data() == "FEFQE") {
            std::cout << "It's the FSI parameter!" <<std::endl;
        }
        else if ((((TObjString*)(params->At(index)))->GetString()).Data() == "NC_other_far") {
            std::cout << "It's the last daggum parameter" <<std::endl;
        }
        else { continue; }
    }
