...
int main(int argc, char** argv){
    ...
    Double_t ctbins_0pi[12] = {-1, 0.6, 0.7, 0.8, 0.85, 0.9, 0.92, 0.94, 0.96, 0.98, 0.99, 1};
    ...
    Double_t ctbins_1pi[12] = {-1, 0.6, 0.7, 0.8, 0.85, 0.9, 0.92, 0.94, 0.96, 0.98, 0.99, 1};
    ...
    Int_t npbins_npi = 14;
    Double_t pbins_npi[15] = {0, 300, 400, 500, 600, 700, 800, 900, 1000, 1250, 1500, 2000, 3000, 5000, 30000}; // out to 30 and combine overflow
    Int_t nctbins_npi = 11;
    Double_t ctbins_npi[12] = {-1, 0.6, 0.7, 0.8, 0.85, 0.9, 0.92, 0.94, 0.96, 0.98, 0.99, 1};
...
//    BANFFSampleBase** samples = new BANFFSampleBase*[7];
	...
	fitParameters->PrintAllParameterInfo();
    ...
    /*TFile* preFitFile = new TFile("preFitParameters2016winter.root","RECREATE");
	preFitFile->cd();
