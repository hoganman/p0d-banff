...
int main(int argc, char** argv){
    ...
    if(argc < 9){
        ...
        std::cout << "Usage: Make2015PostFitFile.exe preFitFile.root FittedParameters0 FittedCovariance0 flux_uncertainty_file.root FittedParameters0 FittedCovariance0  outputfile.root" << std::endl;
        return 1;
    }
