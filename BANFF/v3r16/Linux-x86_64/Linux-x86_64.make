...
BANFF_tag=$(tag)
BANFFROOT=/physics/home/mhogan/software/t2k-software-clone/BANFF/v3r16
BANFF_root=/physics/home/mhogan/software/t2k-software-clone/BANFF/v3r16
BANFFVERSION=v3r16
BANFF_cmtpath=/physics/home/mhogan/software/t2k-software-clone
BANFF_project=software
BANFF_project_release=t2k-software-clone
ROOT_tag=$(tag)
...
BANFF_cppflags= -DBANFF_USED -fPIC -fopenmp -O0 -march=native -Wall -ltcmalloc#
BANFF_linkopts= -L$(BANFFROOT)/$(BANFF_tag) -lBANFF -lMinuit2 -lgomp #
BANFF_stamps= $(BANFFROOT)/$(BANFF_tag)/BANFF.stamp
cpplinkflag=Linux
register_dependencies= version  version  version  version  version  version  version  version  version  version  version 
tag=Linux-x86_64
package=BANFF
version=v3r16
PACKAGE_ROOT=$(BANFFROOT)
srcdir=../src
bin=../$(BANFF_tag)/
BIN=/physics/home/mhogan/software/t2k-software-clone/BANFF/v3r16/$(BANFF_tag)/
javabin=../classes/
mgrdir=cmt
project=software
cmt_installarea_paths= $(cmt_installarea_prefix)/$(CMTCONFIG)/bin
use_linkopts= $(cmt_installarea_linkopts)   $(BANFF_linkopts)  $(nd280Psyche_linkopts)  $(psycheSteering_linkopts)  $(psycheSystematics_linkopts)  $(psycheSelections_linkopts)  $(psycheIO_linkopts)  $(psycheND280Utils_linkopts)  $(psycheUtils_linkopts)  $(psycheEventModel_linkopts)  $(psycheCore_linkopts)  $(ROOT_linkopts)  $(MYSQL_linkopts)  $(GSL_linkopts)  $(EXTERN_linkopts)  $(psychePolicy_linkopts) 
...
use_requirements=requirements $(CMTROOT)/mgr/requirements $(ND280PSYCHEROOT)/cmt/requirements $(PSYCHESTEERINGROOT)/cmt/requirements $(PSYCHESYSTEMATICSROOT)/cmt/requirements $(PSYCHESELECTIONSROOT)/cmt/requirements $(PSYCHEIOROOT)/cmt/requirements $(PSYCHEND280UTILSROOT)/cmt/requirements $(PSYCHEUTILSROOT)/cmt/requirements $(PSYCHEEVENTMODELROOT)/cmt/requirements $(PSYCHECOREROOT)/cmt/requirements $(ROOTROOT)/cmt/requirements $(MYSQLROOT)/cmt/requirements $(GSLROOT)/cmt/requirements $(EXTERNROOT)/cmt/requirements $(PSYCHEPOLICYROOT)/cmt/requirements 
use_includes= $(ppcmd)"$(nd280Psyche_root)/src" $(ppcmd)"$(psycheSteering_root)/src" $(ppcmd)"$(psycheSystematics_root)/src" $(ppcmd)"$(psycheSelections_root)/src" $(ppcmd)"$(psycheIO_root)/src" $(ppcmd)"$(psycheND280Utils_root)/src" $(ppcmd)"$(psycheUtils_root)/src" $(ppcmd)"$(psycheEventModel_root)/src" $(ppcmd)"$(psycheCore_root)/src" $(ppcmd)"/physics/software/t2k/ND280/v11r31/ROOT/v5r34p09n04/Linux-x86_64/include/root" $(ppcmd)"none" $(ppcmd)"/physics/software/t2k/ND280/v11r31/MYSQL/v5r051an01/Linux-x86_64/include/mysql" $(ppcmd)"/physics/software/t2k/ND280/v11r31/GSL/v1r15p0n00/Linux-x86_64/include" $(ppcmd)"$(EXTERN_root)/src" $(ppcmd)"$(psychePolicy_root)/src" 
use_fincludes= $(use_includes)
use_stamps= $(BANFF_stamps)  $(nd280Psyche_stamps)  $(psycheSteering_stamps)  $(psycheSystematics_stamps)  $(psycheSelections_stamps)  $(psycheIO_stamps)  $(psycheND280Utils_stamps)  $(psycheUtils_stamps)  $(psycheEventModel_stamps)  $(psycheCore_stamps)  $(ROOT_stamps)  $(MYSQL_stamps)  $(GSL_stamps)  $(EXTERN_stamps)  $(psychePolicy_stamps) 
use_cflags=  $(BANFF_cflags)  $(nd280Psyche_cflags)  $(psycheSteering_cflags)  $(psycheSystematics_cflags)  $(psycheSelections_cflags)  $(psycheIO_cflags)  $(psycheND280Utils_cflags)  $(psycheUtils_cflags)  $(psycheEventModel_cflags)  $(psycheCore_cflags)  $(ROOT_cflags)  $(MYSQL_cflags)  $(GSL_cflags)  $(EXTERN_cflags)  $(psychePolicy_cflags) 
use_pp_cflags=  $(BANFF_pp_cflags)  $(nd280Psyche_pp_cflags)  $(psycheSteering_pp_cflags)  $(psycheSystematics_pp_cflags)  $(psycheSelections_pp_cflags)  $(psycheIO_pp_cflags)  $(psycheND280Utils_pp_cflags)  $(psycheUtils_pp_cflags)  $(psycheEventModel_pp_cflags)  $(psycheCore_pp_cflags)  $(ROOT_pp_cflags)  $(MYSQL_pp_cflags)  $(GSL_pp_cflags)  $(EXTERN_pp_cflags)  $(psychePolicy_pp_cflags) 
use_cppflags=  $(BANFF_cppflags)  $(nd280Psyche_cppflags)  $(psycheSteering_cppflags)  $(psycheSystematics_cppflags)  $(psycheSelections_cppflags)  $(psycheIO_cppflags)  $(psycheND280Utils_cppflags)  $(psycheUtils_cppflags)  $(psycheEventModel_cppflags)  $(psycheCore_cppflags)  $(ROOT_cppflags)  $(MYSQL_cppflags)  $(GSL_cppflags)  $(EXTERN_cppflags)  $(psychePolicy_cppflags) 
use_pp_cppflags=  $(BANFF_pp_cppflags)  $(nd280Psyche_pp_cppflags)  $(psycheSteering_pp_cppflags)  $(psycheSystematics_pp_cppflags)  $(psycheSelections_pp_cppflags)  $(psycheIO_pp_cppflags)  $(psycheND280Utils_pp_cppflags)  $(psycheUtils_pp_cppflags)  $(psycheEventModel_pp_cppflags)  $(psycheCore_pp_cppflags)  $(ROOT_pp_cppflags)  $(MYSQL_pp_cppflags)  $(GSL_pp_cppflags)  $(EXTERN_pp_cppflags)  $(psychePolicy_pp_cppflags) 
use_fflags=  $(BANFF_fflags)  $(nd280Psyche_fflags)  $(psycheSteering_fflags)  $(psycheSystematics_fflags)  $(psycheSelections_fflags)  $(psycheIO_fflags)  $(psycheND280Utils_fflags)  $(psycheUtils_fflags)  $(psycheEventModel_fflags)  $(psycheCore_fflags)  $(ROOT_fflags)  $(MYSQL_fflags)  $(GSL_fflags)  $(EXTERN_fflags)  $(psychePolicy_fflags) 
use_pp_fflags=  $(BANFF_pp_fflags)  $(nd280Psyche_pp_fflags)  $(psycheSteering_pp_fflags)  $(psycheSystematics_pp_fflags)  $(psycheSelections_pp_fflags)  $(psycheIO_pp_fflags)  $(psycheND280Utils_pp_fflags)  $(psycheUtils_pp_fflags)  $(psycheEventModel_pp_fflags)  $(psycheCore_pp_fflags)  $(ROOT_pp_fflags)  $(MYSQL_pp_fflags)  $(GSL_pp_fflags)  $(EXTERN_pp_fflags)  $(psychePolicy_pp_fflags) 
use_libraries= $(nd280Psyche_libraries)  $(psycheSteering_libraries)  $(psycheSystematics_libraries)  $(psycheSelections_libraries)  $(psycheIO_libraries)  $(psycheND280Utils_libraries)  $(psycheUtils_libraries)  $(psycheEventModel_libraries)  $(psycheCore_libraries)  $(ROOT_libraries)  $(MYSQL_libraries)  $(GSL_libraries)  $(EXTERN_libraries)  $(psychePolicy_libraries) 
includes= $(ppcmd)"$(srcdir)" $(use_includes)
fincludes= $(includes)
BANFF_use_linkopts=  $(BANFF_linkopts)  $(nd280Psyche_linkopts)  $(psycheSteering_linkopts)  $(psycheSystematics_linkopts)  $(psycheSelections_linkopts)  $(psycheIO_linkopts)  $(psycheND280Utils_linkopts)  $(psycheUtils_linkopts)  $(psycheEventModel_linkopts)  $(psycheCore_linkopts)  $(ROOT_linkopts)  $(MYSQL_linkopts)  $(GSL_linkopts)  $(EXTERN_linkopts)  $(psychePolicy_linkopts) 
RunJointFit2017_use_linkopts=  $(BANFF_linkopts)  $(nd280Psyche_linkopts)  $(psycheSteering_linkopts)  $(psycheSystematics_linkopts)  $(psycheSelections_linkopts)  $(psycheIO_linkopts)  $(psycheND280Utils_linkopts)  $(psycheUtils_linkopts)  $(psycheEventModel_linkopts)  $(psycheCore_linkopts)  $(ROOT_linkopts)  $(MYSQL_linkopts)  $(GSL_linkopts)  $(EXTERN_linkopts)  $(psychePolicy_linkopts) 
RunJointFit2016_use_linkopts=  $(BANFF_linkopts)  $(nd280Psyche_linkopts)  $(psycheSteering_linkopts)  $(psycheSystematics_linkopts)  $(psycheSelections_linkopts)  $(psycheIO_linkopts)  $(psycheND280Utils_linkopts)  $(psycheUtils_linkopts)  $(psycheEventModel_linkopts)  $(psycheCore_linkopts)  $(ROOT_linkopts)  $(MYSQL_linkopts)  $(GSL_linkopts)  $(EXTERN_linkopts)  $(psychePolicy_linkopts) 
Make2016PostFitFileAllParams_use_linkopts=  $(BANFF_linkopts)  $(nd280Psyche_linkopts)  $(psycheSteering_linkopts)  $(psycheSystematics_linkopts)  $(psycheSelections_linkopts)  $(psycheIO_linkopts)  $(psycheND280Utils_linkopts)  $(psycheUtils_linkopts)  $(psycheEventModel_linkopts)  $(psycheCore_linkopts)  $(ROOT_linkopts)  $(MYSQL_linkopts)  $(GSL_linkopts)  $(EXTERN_linkopts)  $(psychePolicy_linkopts) 
MakeND280DetectorCov_use_linkopts=  $(BANFF_linkopts)  $(nd280Psyche_linkopts)  $(psycheSteering_linkopts)  $(psycheSystematics_linkopts)  $(psycheSelections_linkopts)  $(psycheIO_linkopts)  $(psycheND280Utils_linkopts)  $(psycheUtils_linkopts)  $(psycheEventModel_linkopts)  $(psycheCore_linkopts)  $(ROOT_linkopts)  $(MYSQL_linkopts)  $(GSL_linkopts)  $(EXTERN_linkopts)  $(psychePolicy_linkopts) 
constituents= version register BANFF RunJointFit2017 RunJointFit2016 Make2016PostFitFileAllParams MakeND280DetectorCov 
all_constituents= $(constituents)
constituentsclean= MakeND280DetectorCovclean Make2016PostFitFileAllParamsclean RunJointFit2016clean RunJointFit2017clean BANFFclean registerclean versionclean 
