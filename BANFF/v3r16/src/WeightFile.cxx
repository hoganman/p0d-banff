...
XsecSysts ParamNameToXsecSysts(std::string paramName){
    ...
    else if(paramName == "FSI_PI_ABS") return FSI_PI_ABS;
    else if(paramName == "FSI_PI_PROD") return FSI_PI_PROD;
    else if((paramName == "FSI_INEL_LO") || (paramName == "FSI_INEL_LO_E")) return FSI_INEL_LO;
    else if((paramName == "FSI_INEL_HI") || (paramName == "FSI_INEL_HI_E")) return FSI_INEL_HI;
    else if((paramName == "FSI_CEX_LO") || (paramName == "FSI_CEX_LO_E")) return FSI_CEX_LO;
    else if((paramName == "FSI_CEX_HI") || (paramName == "FSI_CEX_HI_E")) return FSI_CEX_HI;
