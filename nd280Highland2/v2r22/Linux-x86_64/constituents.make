...
ifdef READONLY
cmt_local_tagfile = /tmp/CMT_$(nd280Highland2_tag).make$(cmt_lock_pid)
else
#cmt_local_tagfile = $(nd280Highland2_tag).make
cmt_local_tagfile = $(bin)$(nd280Highland2_tag).make
endif
...
ifdef READONLY
cmt_local_setup = /tmp/CMT_nd280Highland2setup$(cmt_lock_pid).make
cmt_final_setup = /tmp/CMT_nd280Highland2setup.make
else
#cmt_local_setup = $(bin)nd280Highland2setup$(cmt_lock_pid).make
cmt_local_setup = $(bin)$(package)setup$$$$.make
#cmt_final_setup = $(bin)nd280Highland2setup.make
...
ifdef READONLY
cmt_local_tagfile_doxygen = /tmp/CMT_$(nd280Highland2_tag)_doxygen.make$(cmt_lock_pid)
cmt_final_setup_doxygen = /tmp/CMT_nd280Highland2_doxygensetup.make
cmt_local_doxygen_makefile = /tmp/CMT_doxygen$(cmt_lock_pid).make
else
#cmt_local_tagfile_doxygen = $(nd280Highland2_tag)_doxygen.make
cmt_local_tagfile_doxygen = $(bin)$(nd280Highland2_tag)_doxygen.make
cmt_final_setup_doxygen = $(bin)nd280Highland2_doxygensetup.make
...
ifdef READONLY
cmt_local_tagfile_doxygen = /tmp/CMT_$(nd280Highland2_tag).make$(cmt_lock_pid)
cmt_final_setup_doxygen = /tmp/CMT_nd280Highland2setup.make
cmt_local_doxygen_makefile = /tmp/CMT_doxygen$(cmt_lock_pid).make
else
#cmt_local_tagfile_doxygen = $(nd280Highland2_tag).make
cmt_local_tagfile_doxygen = $(bin)$(nd280Highland2_tag).make
cmt_final_setup_doxygen = $(bin)nd280Highland2setup.make
cmt_local_doxygen_makefile = $(bin)doxygen.make
endif
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(nd280Highland2_tag)_make.make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_nd280Highland2_makesetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(nd280Highland2_tag)_make.make
cmt_local_tagfile_make = $(bin)$(nd280Highland2_tag)_make.make
cmt_final_setup_make = $(bin)nd280Highland2_makesetup.make
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(nd280Highland2_tag).make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_nd280Highland2setup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(nd280Highland2_tag).make
cmt_local_tagfile_make = $(bin)$(nd280Highland2_tag).make
cmt_final_setup_make = $(bin)nd280Highland2setup.make
cmt_local_make_makefile = $(bin)make.make
endif
