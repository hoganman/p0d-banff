...
ifdef READONLY
cmt_local_tagfile = /tmp/CMT_$(highlandDoc_tag).make$(cmt_lock_pid)
else
#cmt_local_tagfile = $(highlandDoc_tag).make
cmt_local_tagfile = $(bin)$(highlandDoc_tag).make
endif
...
ifdef READONLY
cmt_local_setup = /tmp/CMT_highlandDocsetup$(cmt_lock_pid).make
cmt_final_setup = /tmp/CMT_highlandDocsetup.make
else
#cmt_local_setup = $(bin)highlandDocsetup$(cmt_lock_pid).make
cmt_local_setup = $(bin)$(package)setup$$$$.make
#cmt_final_setup = $(bin)highlandDocsetup.make
...
ifdef READONLY
cmt_local_tagfile_doxygen = /tmp/CMT_$(highlandDoc_tag)_doxygen.make$(cmt_lock_pid)
cmt_final_setup_doxygen = /tmp/CMT_highlandDoc_doxygensetup.make
cmt_local_doxygen_makefile = /tmp/CMT_doxygen$(cmt_lock_pid).make
else
#cmt_local_tagfile_doxygen = $(highlandDoc_tag)_doxygen.make
cmt_local_tagfile_doxygen = $(bin)$(highlandDoc_tag)_doxygen.make
cmt_final_setup_doxygen = $(bin)highlandDoc_doxygensetup.make
...
ifdef READONLY
cmt_local_tagfile_doxygen = /tmp/CMT_$(highlandDoc_tag).make$(cmt_lock_pid)
cmt_final_setup_doxygen = /tmp/CMT_highlandDocsetup.make
cmt_local_doxygen_makefile = /tmp/CMT_doxygen$(cmt_lock_pid).make
else
#cmt_local_tagfile_doxygen = $(highlandDoc_tag).make
cmt_local_tagfile_doxygen = $(bin)$(highlandDoc_tag).make
cmt_final_setup_doxygen = $(bin)highlandDocsetup.make
cmt_local_doxygen_makefile = $(bin)doxygen.make
endif
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(highlandDoc_tag)_make.make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_highlandDoc_makesetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(highlandDoc_tag)_make.make
cmt_local_tagfile_make = $(bin)$(highlandDoc_tag)_make.make
cmt_final_setup_make = $(bin)highlandDoc_makesetup.make
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(highlandDoc_tag).make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_highlandDocsetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(highlandDoc_tag).make
cmt_local_tagfile_make = $(bin)$(highlandDoc_tag).make
cmt_final_setup_make = $(bin)highlandDocsetup.make
cmt_local_make_makefile = $(bin)make.make
endif
