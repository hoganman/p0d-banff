...
public :
  ...
  std::string GetSameLevel(const std::string& root_opt="", const std::string& opt="");
  ...
  void DrawGraph(TGraphAsymmErrors* eff, const std::string& uroot_opt, const std::string& uopt, const std::string& leg, double ymax=1.05);

  void DumpGraph(TGraphAsymmErrors* graph, const std::string& uopt);
  ...
  TH1_h* GetEventsVSCut(TTree* tree, const std::string& var, const std::string& cut_norm, int isel, int branch, int& first_cut, int& last_cut,
  ...
  void DrawRatioVSCut(TH1_h* h1, TH1_h* h2, int first_cut,
		      const std::string& root_opt, const std::string& opt, const std::string& leg);
  ...
  void DrawToys(TTree* tree, int nx, double xmin, double xmax, const std::string& cut="", const std::string& root_opt="", const std::string& opt="", const std::string& leg="");
  ...
  void DrawToysBase(TH1_h& result, TH1_h& entries, int nx, double xmin, double xmax, const std::string& root_opt="", const std::string& opt="", const std::string& leg="");
  ...
  void Draw(TTree* tree1, TTree* tree2, const std::string& var, int nx, double xmin, double xmax,
	    const std::string& categ="all", const std::string& cut="", const std::string& root_opt="", const std::string& opt="", double norm2=1, bool scale_errors=false);
  void Draw(TTree* tree1, TTree* tree2, const std::string& var, int nbins, double* xbins,
	    const std::string& categ="all", const std::string& cut="", const std::string& root_opt="", const std::string& opt="", double norm2=1,  bool scale_errors=false);

  void Draw(TTree* tree1, TTree* tree2, const std::string& var, int nx, double xmin, double xmax,
            const std::string& categ, const std::string& cut, const std::string& root_opt, const std::string& opt, double norm1, double norm2, bool scale_errors=false);
  void Draw(TTree* tree1, TTree* tree2, const std::string& var, int nbins, double* xbins,
            const std::string& categ, const std::string& cut, const std::string& root_opt, const std::string& opt, double norm1, double norm2, bool scale_errors=false);
  ...
  void DrawRatioTwoCuts(TTree* tree1, TTree* tree2, const std::string& var, int nx, double* xbins, int ny, double* ybins,
		 const std::string& cut1="", const std::string& cut2="", const std::string& root_opt="", const std::string& opt="",  const std::string& leg="", double norm=1, bool scale_errors=false);
  ...
  void DrawRatioTwoCuts(TTree* tree1, TTree* tree2, const std::string& var, int nx, double xmin, double xmax,
                 const std::string& cut1, const std::string& cut2,  const std::string& root_opt="", const std::string& opt="",  const std::string& leg="", double norm=1);
  virtual void DrawRatioTwoCuts(TTree* tree1, TTree* tree2, const std::string& var, int nx, double* xbins,
                         const std::string& cut1,const std::string& cut2, const std::string& root_opt="", const std::string& opt="",  const std::string& leg="", double norm=1);
  ...
  void Project(HistoStack* hs1, HistoStack* hs2, TTree* tree1, TTree* tree2, const std::string& var, int nx, double* xbins, int ny, double* ybins, 
               const std::string& categ="all", const std::string& cut="", const std::string& root_opt="", const std::string& opt="", double norm1=1, double norm2=1,bool scale_errors=true);


  void ProjectTwoCuts(HistoStack* hs1, HistoStack* hs2, TTree* tree1, TTree* tree2, const std::string& var, int nx, double* xbins, int ny, double* ybins, 
                  const std::string& categ="all", const std::string& cut1="", const std::string& cut2="", const std::string& root_opt="", const std::string& opt="", double norm1=1, double norm2=1,bool scale_errors=true);
  ...
  void DrawHisto(TH1* h,                                 const std::string& root_opt="", const std::string& opt="",const std::string& leg="", const std::string& leg_opt="");
  ...
  TH1_h* GetHisto(TTree* tree, const std::string& name, const std::string& var, int nx, double* xbins,
		 const std::string& cut, const std::string& root_opt, const std::string& opt, double scale, bool scale_errors=true, int toy_ref=-1);

  virtual TH2_h* GetHisto(TTree* tree, const std::string& name, const std::string& var, int nx, double* xbins, int ny, double* ybins,
			 const std::string& cut, const std::string& root_opt, const std::string& opt, double scale, bool scale_errors=true, int toy_ref=-1);

  virtual TH1_h* GetHisto(HistoStack* hs, TTree* tree, const std::string& name, const std::string& var, int nx, double* xbins,
			 const std::string& cut, const std::string& root_opt, const std::string& opt, TH1_h*& hsyst, double scale, bool scale_errors=true, int toy_ref=-1);
  ...
  virtual TH1_h* GetRatioHisto(TTree* tree1, TTree* tree2, const std::string& name, const std::string& var, int nx, double* xbins,
  ...
  /// switch on/off auto labels
  void SetAutoLabels(bool autol = true){_autoTitleY=autol;}
  ...
  Versioning&           ver() {return ND::versioning();}
  ...
  */
  ...
  /// stacked histograms
  void ReadCategories(const std::string& file){cat().ReadCategories(file);}
  ...
  /// Useful if you want to save it to file or modify something.
  TH1* GetLastStackTotal(int nexttolast = 0) {
    std::cout << "If it crashes you should maybe use GetLastHisto instead.\n";
    if ((int)_saved_histoStacks.size() <= nexttolast || nexttolast < 0)
       { std::cout << "No histoStacks found!\n"; return NULL; }
  ...
  /// Get the total from the most recently-drawn stacked histogram.
  /// Useful if you want to save it to file or modify something.
  TH2* GetLastStackTotal2D(int nexttolast = 0) {
    std::cout << "If it crashes you should maybe use GetLastHisto instead.\n";
    if ((int)_saved_histoStacks.size() <= nexttolast || nexttolast < 0)
       { std::cout << "No histoStacks found!\n"; return NULL; }
    HistoStack* s = _saved_histoStacks[(int)_saved_histoStacks.size() - nexttolast - 1];
 ...
 protected:
  ...
  void PrintValueVSCut(Int_t first_cut, TH1_h* hdata, TH1_h* hmc=NULL, const std::string& val_name="#events", const std::string& uopt="");

  void SetCutNames(TH1_h* hall,Int_t first_cut, Int_t isel, Int_t ibranch);
  
  std::string BuildAccumLevelCut(const std::string& tree_name, Int_t nsel, Int_t isel, Int_t ibranch, Int_t icut);

  TH1_h* CloneHistoFromFirstBin(TH1_h* h1, TH1_h* h2_0, const std::string& name);

  void DrawEventsVSCut(TH1_h* hall, const std::string& root_opt, const std::string& uopt, const std::string& leg);

  void DrawLegend(const std::string& uopt, const std::string& leg);
