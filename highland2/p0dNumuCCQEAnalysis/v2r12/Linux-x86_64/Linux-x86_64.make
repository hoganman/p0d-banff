...
tag=Linux-x86_64
package=p0dNumuCCQEAnalysis
version=v2r12
PACKAGE_ROOT=$(P0DNUMUCCQEANALYSISROOT)
srcdir=../src
bin=../$(p0dNumuCCQEAnalysis_tag)/
BIN=/physics/home/mhogan/software/t2k-software-clone/highland2/p0dNumuCCQEAnalysis/v2r12/$(p0dNumuCCQEAnalysis_tag)/
javabin=../classes/
mgrdir=cmt
project=software
cmt_installarea_paths= $(cmt_installarea_prefix)/$(CMTCONFIG)/bin
use_linkopts= $(cmt_installarea_linkopts)   $(p0dNumuCCQEAnalysis_linkopts)  $(p0dNumuCCAnalysis_linkopts)  $(numuCCAnalysis_linkopts)  $(baseTrackerAnalysis_linkopts)  $(baseAnalysis_linkopts)  $(highlandTools_linkopts)  $(highlandIO_linkopts)  $(highlandCorrections_linkopts)  $(highlandUtils_linkopts)  $(highlandCore_linkopts)  $(psycheSystematics_linkopts)  $(psycheSelections_linkopts)  $(psycheIO_linkopts)  $(psycheND280Utils_linkopts)  $(psycheUtils_linkopts)  $(highlandEventModel_linkopts)  $(psycheEventModel_linkopts)  $(psycheCore_linkopts)  $(psychePolicy_linkopts)  $(oaAnalysisReader_linkopts)  $(ROOT_linkopts)  $(MYSQL_linkopts)  $(GSL_linkopts)  $(EXTERN_linkopts) 
...
use_requirements=requirements $(CMTROOT)/mgr/requirements $(P0DNUMUCCANALYSISROOT)/cmt/requirements $(NUMUCCANALYSISROOT)/cmt/requirements $(BASETRACKERANALYSISROOT)/cmt/requirements $(BASEANALYSISROOT)/cmt/requirements $(HIGHLANDTOOLSROOT)/cmt/requirements $(HIGHLANDIOROOT)/cmt/requirements $(HIGHLANDCORRECTIONSROOT)/cmt/requirements $(HIGHLANDUTILSROOT)/cmt/requirements $(HIGHLANDCOREROOT)/cmt/requirements $(PSYCHESYSTEMATICSROOT)/cmt/requirements $(PSYCHESELECTIONSROOT)/cmt/requirements $(PSYCHEIOROOT)/cmt/requirements $(PSYCHEND280UTILSROOT)/cmt/requirements $(PSYCHEUTILSROOT)/cmt/requirements $(HIGHLANDEVENTMODELROOT)/cmt/requirements $(PSYCHEEVENTMODELROOT)/cmt/requirements $(PSYCHECOREROOT)/cmt/requirements $(PSYCHEPOLICYROOT)/cmt/requirements $(OAANALYSISREADERROOT)/cmt/requirements $(ROOTROOT)/cmt/requirements $(MYSQLROOT)/cmt/requirements $(GSLROOT)/cmt/requirements $(EXTERNROOT)/cmt/requirements 
use_includes= $(ppcmd)"$(p0dNumuCCAnalysis_root)/src" $(ppcmd)"$(numuCCAnalysis_root)/src" $(ppcmd)"$(baseTrackerAnalysis_root)/src" $(ppcmd)"$(baseAnalysis_root)/src" $(ppcmd)"$(highlandTools_root)/src" $(ppcmd)"$(highlandIO_root)/src" $(ppcmd)"$(highlandCorrections_root)/src" $(ppcmd)"$(highlandUtils_root)/src" $(ppcmd)"$(highlandCore_root)/src" $(ppcmd)"$(psycheSystematics_root)/src" $(ppcmd)"$(psycheSelections_root)/src" $(ppcmd)"$(psycheIO_root)/src" $(ppcmd)"$(psycheND280Utils_root)/src" $(ppcmd)"$(psycheUtils_root)/src" $(ppcmd)"$(highlandEventModel_root)/src" $(ppcmd)"$(psycheEventModel_root)/src" $(ppcmd)"$(psycheCore_root)/src" $(ppcmd)"$(psychePolicy_root)/src" $(ppcmd)"$(oaAnalysisReader_root)/src" $(ppcmd)"/physics/software/t2k/ND280/v11r31/ROOT/v5r34p09n04/Linux-x86_64/include/root" $(ppcmd)"none" $(ppcmd)"/physics/software/t2k/ND280/v11r31/MYSQL/v5r051an01/Linux-x86_64/include/mysql" $(ppcmd)"/physics/software/t2k/ND280/v11r31/GSL/v1r15p0n00/Linux-x86_64/include" $(ppcmd)"$(EXTERN_root)/src" 
use_fincludes= $(use_includes)
use_stamps= $(p0dNumuCCQEAnalysis_stamps)  $(p0dNumuCCAnalysis_stamps)  $(numuCCAnalysis_stamps)  $(baseTrackerAnalysis_stamps)  $(baseAnalysis_stamps)  $(highlandTools_stamps)  $(highlandIO_stamps)  $(highlandCorrections_stamps)  $(highlandUtils_stamps)  $(highlandCore_stamps)  $(psycheSystematics_stamps)  $(psycheSelections_stamps)  $(psycheIO_stamps)  $(psycheND280Utils_stamps)  $(psycheUtils_stamps)  $(highlandEventModel_stamps)  $(psycheEventModel_stamps)  $(psycheCore_stamps)  $(psychePolicy_stamps)  $(oaAnalysisReader_stamps)  $(ROOT_stamps)  $(MYSQL_stamps)  $(GSL_stamps)  $(EXTERN_stamps) 
use_cflags=  $(p0dNumuCCQEAnalysis_cflags)  $(p0dNumuCCAnalysis_cflags)  $(numuCCAnalysis_cflags)  $(baseTrackerAnalysis_cflags)  $(baseAnalysis_cflags)  $(highlandTools_cflags)  $(highlandIO_cflags)  $(highlandCorrections_cflags)  $(highlandUtils_cflags)  $(highlandCore_cflags)  $(psycheSystematics_cflags)  $(psycheSelections_cflags)  $(psycheIO_cflags)  $(psycheND280Utils_cflags)  $(psycheUtils_cflags)  $(highlandEventModel_cflags)  $(psycheEventModel_cflags)  $(psycheCore_cflags)  $(psychePolicy_cflags)  $(oaAnalysisReader_cflags)  $(ROOT_cflags)  $(MYSQL_cflags)  $(GSL_cflags)  $(EXTERN_cflags) 
use_pp_cflags=  $(p0dNumuCCQEAnalysis_pp_cflags)  $(p0dNumuCCAnalysis_pp_cflags)  $(numuCCAnalysis_pp_cflags)  $(baseTrackerAnalysis_pp_cflags)  $(baseAnalysis_pp_cflags)  $(highlandTools_pp_cflags)  $(highlandIO_pp_cflags)  $(highlandCorrections_pp_cflags)  $(highlandUtils_pp_cflags)  $(highlandCore_pp_cflags)  $(psycheSystematics_pp_cflags)  $(psycheSelections_pp_cflags)  $(psycheIO_pp_cflags)  $(psycheND280Utils_pp_cflags)  $(psycheUtils_pp_cflags)  $(highlandEventModel_pp_cflags)  $(psycheEventModel_pp_cflags)  $(psycheCore_pp_cflags)  $(psychePolicy_pp_cflags)  $(oaAnalysisReader_pp_cflags)  $(ROOT_pp_cflags)  $(MYSQL_pp_cflags)  $(GSL_pp_cflags)  $(EXTERN_pp_cflags) 
use_cppflags=  $(p0dNumuCCQEAnalysis_cppflags)  $(p0dNumuCCAnalysis_cppflags)  $(numuCCAnalysis_cppflags)  $(baseTrackerAnalysis_cppflags)  $(baseAnalysis_cppflags)  $(highlandTools_cppflags)  $(highlandIO_cppflags)  $(highlandCorrections_cppflags)  $(highlandUtils_cppflags)  $(highlandCore_cppflags)  $(psycheSystematics_cppflags)  $(psycheSelections_cppflags)  $(psycheIO_cppflags)  $(psycheND280Utils_cppflags)  $(psycheUtils_cppflags)  $(highlandEventModel_cppflags)  $(psycheEventModel_cppflags)  $(psycheCore_cppflags)  $(psychePolicy_cppflags)  $(oaAnalysisReader_cppflags)  $(ROOT_cppflags)  $(MYSQL_cppflags)  $(GSL_cppflags)  $(EXTERN_cppflags) 
use_pp_cppflags=  $(p0dNumuCCQEAnalysis_pp_cppflags)  $(p0dNumuCCAnalysis_pp_cppflags)  $(numuCCAnalysis_pp_cppflags)  $(baseTrackerAnalysis_pp_cppflags)  $(baseAnalysis_pp_cppflags)  $(highlandTools_pp_cppflags)  $(highlandIO_pp_cppflags)  $(highlandCorrections_pp_cppflags)  $(highlandUtils_pp_cppflags)  $(highlandCore_pp_cppflags)  $(psycheSystematics_pp_cppflags)  $(psycheSelections_pp_cppflags)  $(psycheIO_pp_cppflags)  $(psycheND280Utils_pp_cppflags)  $(psycheUtils_pp_cppflags)  $(highlandEventModel_pp_cppflags)  $(psycheEventModel_pp_cppflags)  $(psycheCore_pp_cppflags)  $(psychePolicy_pp_cppflags)  $(oaAnalysisReader_pp_cppflags)  $(ROOT_pp_cppflags)  $(MYSQL_pp_cppflags)  $(GSL_pp_cppflags)  $(EXTERN_pp_cppflags) 
use_fflags=  $(p0dNumuCCQEAnalysis_fflags)  $(p0dNumuCCAnalysis_fflags)  $(numuCCAnalysis_fflags)  $(baseTrackerAnalysis_fflags)  $(baseAnalysis_fflags)  $(highlandTools_fflags)  $(highlandIO_fflags)  $(highlandCorrections_fflags)  $(highlandUtils_fflags)  $(highlandCore_fflags)  $(psycheSystematics_fflags)  $(psycheSelections_fflags)  $(psycheIO_fflags)  $(psycheND280Utils_fflags)  $(psycheUtils_fflags)  $(highlandEventModel_fflags)  $(psycheEventModel_fflags)  $(psycheCore_fflags)  $(psychePolicy_fflags)  $(oaAnalysisReader_fflags)  $(ROOT_fflags)  $(MYSQL_fflags)  $(GSL_fflags)  $(EXTERN_fflags) 
use_pp_fflags=  $(p0dNumuCCQEAnalysis_pp_fflags)  $(p0dNumuCCAnalysis_pp_fflags)  $(numuCCAnalysis_pp_fflags)  $(baseTrackerAnalysis_pp_fflags)  $(baseAnalysis_pp_fflags)  $(highlandTools_pp_fflags)  $(highlandIO_pp_fflags)  $(highlandCorrections_pp_fflags)  $(highlandUtils_pp_fflags)  $(highlandCore_pp_fflags)  $(psycheSystematics_pp_fflags)  $(psycheSelections_pp_fflags)  $(psycheIO_pp_fflags)  $(psycheND280Utils_pp_fflags)  $(psycheUtils_pp_fflags)  $(highlandEventModel_pp_fflags)  $(psycheEventModel_pp_fflags)  $(psycheCore_pp_fflags)  $(psychePolicy_pp_fflags)  $(oaAnalysisReader_pp_fflags)  $(ROOT_pp_fflags)  $(MYSQL_pp_fflags)  $(GSL_pp_fflags)  $(EXTERN_pp_fflags) 
use_libraries= $(p0dNumuCCAnalysis_libraries)  $(numuCCAnalysis_libraries)  $(baseTrackerAnalysis_libraries)  $(baseAnalysis_libraries)  $(highlandTools_libraries)  $(highlandIO_libraries)  $(highlandCorrections_libraries)  $(highlandUtils_libraries)  $(highlandCore_libraries)  $(psycheSystematics_libraries)  $(psycheSelections_libraries)  $(psycheIO_libraries)  $(psycheND280Utils_libraries)  $(psycheUtils_libraries)  $(highlandEventModel_libraries)  $(psycheEventModel_libraries)  $(psycheCore_libraries)  $(psychePolicy_libraries)  $(oaAnalysisReader_libraries)  $(ROOT_libraries)  $(MYSQL_libraries)  $(GSL_libraries)  $(EXTERN_libraries) 
fincludes= $(includes)
p0dNumuCCQEAnalysis_use_linkopts=  $(p0dNumuCCQEAnalysis_linkopts)  $(p0dNumuCCAnalysis_linkopts)  $(numuCCAnalysis_linkopts)  $(baseTrackerAnalysis_linkopts)  $(baseAnalysis_linkopts)  $(highlandTools_linkopts)  $(highlandIO_linkopts)  $(highlandCorrections_linkopts)  $(highlandUtils_linkopts)  $(highlandCore_linkopts)  $(psycheSystematics_linkopts)  $(psycheSelections_linkopts)  $(psycheIO_linkopts)  $(psycheND280Utils_linkopts)  $(psycheUtils_linkopts)  $(highlandEventModel_linkopts)  $(psycheEventModel_linkopts)  $(psycheCore_linkopts)  $(psychePolicy_linkopts)  $(oaAnalysisReader_linkopts)  $(ROOT_linkopts)  $(MYSQL_linkopts)  $(GSL_linkopts)  $(EXTERN_linkopts) 
RunP0DNumuCCQEAnalysis_use_linkopts=  $(p0dNumuCCQEAnalysis_linkopts)  $(p0dNumuCCAnalysis_linkopts)  $(numuCCAnalysis_linkopts)  $(baseTrackerAnalysis_linkopts)  $(baseAnalysis_linkopts)  $(highlandTools_linkopts)  $(highlandIO_linkopts)  $(highlandCorrections_linkopts)  $(highlandUtils_linkopts)  $(highlandCore_linkopts)  $(psycheSystematics_linkopts)  $(psycheSelections_linkopts)  $(psycheIO_linkopts)  $(psycheND280Utils_linkopts)  $(psycheUtils_linkopts)  $(highlandEventModel_linkopts)  $(psycheEventModel_linkopts)  $(psycheCore_linkopts)  $(psychePolicy_linkopts)  $(oaAnalysisReader_linkopts)  $(ROOT_linkopts)  $(MYSQL_linkopts)  $(GSL_linkopts)  $(EXTERN_linkopts) 
constituents= p0dNumuCCQEAnalysis RunP0DNumuCCQEAnalysis 
all_constituents= $(constituents)
constituentsclean= RunP0DNumuCCQEAnalysisclean p0dNumuCCQEAnalysisclean 
