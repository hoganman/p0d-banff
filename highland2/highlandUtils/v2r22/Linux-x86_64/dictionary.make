...
#  Document dictionary
#
#   Generated Mon Oct  9 06:39:27 2017  by mhogan
#
#====================================
...
dictionary :: $(filter %_LinkDef.rootcint,$(dictionary_output)ControlPanel_LinkDef.rootcint)
	@echo "------> dictionary ok"

ControlPanel_LinkDef_h_dependencies = ../src/EventDisplay/ControlPanel_LinkDef.h
# -*- makefile -*-
# 
# A makefile fragment used by CMT to build the ROOT dictionary files.
#

$(dict)ControlPanel_LinkDef.rootcint : $(dict)$(patsubst %_LinkDef,%_Dict,ControlPanel_LinkDef).cxx
	@touch $@

$(dict)$(patsubst %_LinkDef,%_Dict,ControlPanel_LinkDef).cxx : \
    $(patsubst %_LinkDef.h,%.h*,$(src)EventDisplay/ControlPanel_LinkDef.h) \
    $(src)EventDisplay/ControlPanel_LinkDef.h  $(ROOT_stamps)
