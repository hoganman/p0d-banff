...
ifdef READONLY
cmt_local_tagfile = /tmp/CMT_$(highlandSystematics_tag).make$(cmt_lock_pid)
else
#cmt_local_tagfile = $(highlandSystematics_tag).make
cmt_local_tagfile = $(bin)$(highlandSystematics_tag).make
endif
...
ifdef READONLY
cmt_local_setup = /tmp/CMT_highlandSystematicssetup$(cmt_lock_pid).make
cmt_final_setup = /tmp/CMT_highlandSystematicssetup.make
else
#cmt_local_setup = $(bin)highlandSystematicssetup$(cmt_lock_pid).make
...
ifdef READONLY
cmt_local_tagfile_doxygen = /tmp/CMT_$(highlandSystematics_tag)_doxygen.make$(cmt_lock_pid)
cmt_final_setup_doxygen = /tmp/CMT_highlandSystematics_doxygensetup.make
cmt_local_doxygen_makefile = /tmp/CMT_doxygen$(cmt_lock_pid).make
else
#cmt_local_tagfile_doxygen = $(highlandSystematics_tag)_doxygen.make
cmt_local_tagfile_doxygen = $(bin)$(highlandSystematics_tag)_doxygen.make
cmt_final_setup_doxygen = $(bin)highlandSystematics_doxygensetup.make
...
ifdef READONLY
cmt_local_tagfile_doxygen = /tmp/CMT_$(highlandSystematics_tag).make$(cmt_lock_pid)
cmt_final_setup_doxygen = /tmp/CMT_highlandSystematicssetup.make
cmt_local_doxygen_makefile = /tmp/CMT_doxygen$(cmt_lock_pid).make
else
#cmt_local_tagfile_doxygen = $(highlandSystematics_tag).make
cmt_local_tagfile_doxygen = $(bin)$(highlandSystematics_tag).make
cmt_final_setup_doxygen = $(bin)highlandSystematicssetup.make
cmt_local_doxygen_makefile = $(bin)doxygen.make
endif
...
highlandSystematics_extratags = -tag_add=target_highlandSystematics

#$(cmt_local_tagfile_highlandSystematics) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_highlandSystematics) ::
else
$(cmt_local_tagfile_highlandSystematics) :
endif
	$(echo) "(constituents.make) Rebuilding setup.make $(cmt_local_tagfile_highlandSystematics)"
	@if test -f $(cmt_local_tagfile_highlandSystematics); then /bin/rm -f $(cmt_local_tagfile_highlandSystematics); fi ; \
	  $(cmtexe) -tag=$(tags) $(highlandSystematics_extratags) build tag_makefile >>$(cmt_local_tagfile_highlandSystematics); \
	  if test -f $(cmt_final_setup_highlandSystematics); then /bin/rm -f $(cmt_final_setup_highlandSystematics); fi; \
	  $(cmtexe) -tag=$(tags) $(highlandSystematics_extratags) show setup >>$(cmt_final_setup_highlandSystematics)
	$(echo) setup.make ok
...
ifndef QUICK
$(cmt_local_highlandSystematics_makefile) :: $(highlandSystematics_dependencies) $(cmt_local_tagfile_highlandSystematics) build_library_links dirs
else
$(cmt_local_highlandSystematics_makefile) :: $(cmt_local_tagfile_highlandSystematics)
endif
	$(echo) "(constituents.make) Building highlandSystematics.make"; \
	  $(cmtexe) -tag=$(tags) $(highlandSystematics_extratags) build constituent_makefile -out=$(cmt_local_highlandSystematics_makefile) highlandSystematics

highlandSystematics :: $(highlandSystematics_dependencies) $(cmt_local_highlandSystematics_makefile)
	$(echo) "(constituents.make) Starting highlandSystematics"
	@$(MAKE) -f $(cmt_local_highlandSystematics_makefile) cmt_lock_pid=$${cmt_lock_pid} highlandSystematics
	$(echo) "(constituents.make) highlandSystematics done"

clean :: highlandSystematicsclean

highlandSystematicsclean :: $(highlandSystematicsclean_dependencies) ##$(cmt_local_highlandSystematics_makefile)
	$(echo) "(constituents.make) Starting highlandSystematicsclean"
	@-if test -f $(cmt_local_highlandSystematics_makefile); then \
	  $(MAKE) -f $(cmt_local_highlandSystematics_makefile) cmt_lock_pid=$${cmt_lock_pid} highlandSystematicsclean; \
	fi

##	  /bin/rm -f $(cmt_local_highlandSystematics_makefile) $(bin)highlandSystematics_dependencies.make

install :: highlandSystematicsinstall

highlandSystematicsinstall :: $(highlandSystematics_dependencies) $(cmt_local_highlandSystematics_makefile)
	$(echo) "(constituents.make) Starting install highlandSystematics"
	@-$(MAKE) -f $(cmt_local_highlandSystematics_makefile) cmt_lock_pid=$${cmt_lock_pid} install
	$(echo) "(constituents.make) install highlandSystematics done"

uninstall :: highlandSystematicsuninstall

highlandSystematicsuninstall :: $(cmt_local_highlandSystematics_makefile)
	$(echo) "(constituents.make) Starting uninstall highlandSystematics"
	@-$(MAKE) -f $(cmt_local_highlandSystematics_makefile) cmt_lock_pid=$${cmt_lock_pid} uninstall
	$(echo) "(constituents.make) uninstall highlandSystematics done"
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(highlandSystematics_tag)_make.make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_highlandSystematics_makesetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(highlandSystematics_tag)_make.make
cmt_local_tagfile_make = $(bin)$(highlandSystematics_tag)_make.make
cmt_final_setup_make = $(bin)highlandSystematics_makesetup.make
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(highlandSystematics_tag).make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_highlandSystematicssetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(highlandSystematics_tag).make
cmt_local_tagfile_make = $(bin)$(highlandSystematics_tag).make
cmt_final_setup_make = $(bin)highlandSystematicssetup.make
cmt_local_make_makefile = $(bin)make.make
endif
