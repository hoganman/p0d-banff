//
// File generated by /physics/software/t2k/ND280/v11r31/ROOT/v5r34p09n04/Linux-x86_64/bin/rootcint at Mon Oct  9 06:37:42 2017
...
namespace ROOT {
   ...
   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Versioning*)
   {
      // Make sure the shadow class has the right sizeof
      R__ASSERT(sizeof(::Versioning) == sizeof(::ROOT::Shadow::Versioning));
      ::Versioning *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::Versioning),0);
      static ::ROOT::TGenericClassInfo 
         instance("Versioning", "./../src/VersionManager.hxx", 54,
                  typeid(::Versioning), DefineBehavior(ptr, ptr),
   ...
   TGenericClassInfo *GenerateInitInstance(const ::Versioning*)
   {
   ...
   static void Versioning_Dictionary() {
      ::ROOT::GenerateInitInstanceLocal((const ::Versioning*)0x0)->GetClass();
   }
...
namespace ROOT {
   void Versioning_ShowMembers(void *obj, TMemberInspector &R__insp)
   {
      ...
      typedef ::ROOT::Shadow::Versioning ShadowClass;
      ShadowClass *sobj = (ShadowClass*)obj;
      if (sobj) { } // Dummy usage just in case there is no datamember.

      TClass *R__cl  = ::ROOT::GenerateInitInstanceLocal((const ::Versioning*)0x0)->GetClass();
      if (R__cl || R__insp.IsA()) { }
...
} // end of namespace ROOT for class ::Versioning
...
namespace ROOT {
   ...
   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<PackageVersion*>*)
   {
      vector<PackageVersion*> *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(vector<PackageVersion*>),0);
      static ::ROOT::TGenericClassInfo 
         instance("vector<PackageVersion*>", -2, "/physics/software/t2k/ND280/v11r31/ROOT/v5r34p09n04/Linux-x86_64/lib/root/cint/cint/lib/prec_stl/vector", 49,
                  typeid(vector<PackageVersion*>), DefineBehavior(ptr, ptr),
      ...
      instance.AdoptCollectionProxyInfo(TCollectionProxyInfo::Generate(TCollectionProxyInfo::Pushback< vector<PackageVersion*> >()));
      return &instance;
   }
   // Static variable to force the class initialization
   ...
   // Dictionary for non-ClassDef classes
   static void vectorlEPackageVersionmUgR_Dictionary() {
      ::ROOT::GenerateInitInstanceLocal((const vector<PackageVersion*>*)0x0)->GetClass();
   }
...
} // end of namespace ROOT for class vector<PackageVersion*>
...
/* Versioning */
static int G__VersionManager_Dict_497_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__VersionManager_Dict_497_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__VersionManager_Dict_497_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__VersionManager_Dict_497_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((Versioning*) G__getstructoffset())->GetProduction(*(string*) libp->para[0].ref));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__VersionManager_Dict_497_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         string* pobj;
...
static int G__VersionManager_Dict_497_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__VersionManager_Dict_497_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         string* pobj;
...
static int G__VersionManager_Dict_497_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__VersionManager_Dict_497_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__VersionManager_Dict_497_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
extern "C" void G__cpp_setup_inheritanceVersionManager_Dict() {
   ...
   if(0==G__getnumbaseclass(G__get_linked_tagnum(&G__VersionManager_DictLN_Versioning))) {
     Versioning *G__Lderived;
     G__Lderived=(Versioning*)0x1000;
     {
       HLClonesArray *G__Lpbase=(HLClonesArray*)G__Lderived;
       G__inheritance_setup(G__get_linked_tagnum(&G__VersionManager_DictLN_Versioning),G__get_linked_tagnum(&G__VersionManager_DictLN_HLClonesArray),(long)G__Lpbase-(long)G__Lderived,1,1);
     }
   }
}
...
static void G__setup_memvarVersioning(void) {
   G__tag_memvar_setup(G__get_linked_tagnum(&G__VersionManager_DictLN_Versioning));
   { Versioning *p; p=(Versioning*)0x1000; if (p) { }
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__VersionManager_DictLN_Versioning),-1,-2,4,"_versioning=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__VersionManager_DictLN_vectorlEstringcOallocatorlEstringgRsPgR),G__defined_typename("vector<std::string>"),-1,4,"_prodnd280Version=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__VersionManager_DictLN_vectorlEstringcOallocatorlEstringgRsPgR),G__defined_typename("vector<std::string>"),-1,4,"_prodoaAnalysisVersion=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__VersionManager_DictLN_vectorlEintcOallocatorlEintgRsPgR),G__defined_typename("vector<ProdId_h>"),-1,4,"_prodId=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__VersionManager_DictLN_vectorlEstringcOallocatorlEstringgRsPgR),G__defined_typename("vector<std::string>"),-1,4,"_prodName=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__VersionManager_DictLN_vectorlEPackageVersionmUcOallocatorlEPackageVersionmUgRsPgR),G__defined_typename("vector<PackageVersion*>"),-1,4,"_packages=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memfuncVersioning(void) {
   /* Versioning */
   G__tag_memfunc_setup(G__get_linked_tagnum(&G__VersionManager_DictLN_Versioning));
   G__memfunc_setup("Get",288,G__VersionManager_Dict_497_0_1, 117, G__get_linked_tagnum(&G__VersionManager_DictLN_Versioning), -1, 1, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Versioning& (*)())(&Versioning::Get) ), 0);
   G__memfunc_setup("CheckVersionCompatibility",2590,G__VersionManager_Dict_497_0_2, 103, -1, -1, 0, 2, 1, 1, 0, 
"i - 'ProdId_h' 0 - prodInput i - 'ProdId_h' 0 - prodReader", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("AddProduction",1328,G__VersionManager_Dict_497_0_3, 121, -1, -1, 0, 4, 1, 1, 0, 
"i - 'ProdId_h' 0 - prodId u 'string' - 11 - prodName "
"u 'string' - 11 - nd280Version u 'string' - 11 - oaAnalysisVersion", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetProduction",1351,G__VersionManager_Dict_497_0_4, 105, -1, G__defined_typename("ProdId_h"), 0, 1, 1, 1, 0, "u 'string' - 11 - softVersion", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetProductionName",1736,G__VersionManager_Dict_497_0_5, 117, G__get_linked_tagnum(&G__VersionManager_DictLN_string), -1, 0, 1, 1, 1, 0, "u 'string' - 11 - softVersion", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("AddPackage",949,G__VersionManager_Dict_497_0_6, 121, -1, -1, 0, 2, 1, 1, 0, 
"u 'string' - 11 - name u 'string' - 11 - version", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetPackageVersion",1714,G__VersionManager_Dict_497_0_7, 117, G__get_linked_tagnum(&G__VersionManager_DictLN_string), -1, 0, 1, 1, 1, 0, "u 'string' - 11 - name", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("ReadVersions",1237,G__VersionManager_Dict_497_0_8, 121, -1, -1, 0, 1, 1, 1, 0, "u 'string' - 11 - file", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DumpVersions",1263,G__VersionManager_Dict_497_0_9, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Versioning",1060,(G__InterfaceMethod) NULL, 105, G__get_linked_tagnum(&G__VersionManager_DictLN_Versioning), -1, 0, 0, 1, 4, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Versioning",1060,(G__InterfaceMethod) NULL, 105, G__get_linked_tagnum(&G__VersionManager_DictLN_Versioning), -1, 0, 1, 1, 4, 0, "u 'Versioning' - 41 - -", (char*)NULL, (void*) NULL, 0);
...
"u 'string' - 1 - oaAnalysisVersion", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("ConvertProduction",1800,(G__InterfaceMethod) NULL, 117, G__get_linked_tagnum(&G__VersionManager_DictLN_string), -1, 0, 1, 1, 4, 0, "i - 'ProdId_h' 0 - prod", (char*)NULL, (void*) NULL, 0);
...
"i - - 1 - r i - - 1 - p", (char*)NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~Versioning", 1186, G__VersionManager_Dict_497_0_17, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   G__tag_memfunc_reset();
}
...
G__linked_taginfo G__VersionManager_DictLN_HLClonesArray = { "HLClonesArray" , 99 , -1 };
G__linked_taginfo G__VersionManager_DictLN_PackageVersion = { "PackageVersion" , 99 , -1 };
G__linked_taginfo G__VersionManager_DictLN_Versioning = { "Versioning" , 99 , -1 };
...
extern "C" void G__cpp_reset_tagtableVersionManager_Dict() {
  ...
  G__VersionManager_DictLN_HLClonesArray.tagnum = -1 ;
  G__VersionManager_DictLN_PackageVersion.tagnum = -1 ;
  G__VersionManager_DictLN_Versioning.tagnum = -1 ;
...
extern "C" void G__cpp_setup_tagtableVersionManager_Dict() {
   ...
   G__get_linked_tagnum_fwd(&G__VersionManager_DictLN_HLClonesArray);
   ...
   G__tagtable_setup(G__get_linked_tagnum_fwd(&G__VersionManager_DictLN_Versioning),sizeof(Versioning),-1,298752,(char*)NULL,G__setup_memvarVersioning,G__setup_memfuncVersioning);
