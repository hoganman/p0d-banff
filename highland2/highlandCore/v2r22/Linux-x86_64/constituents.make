...
ifdef READONLY
cmt_local_tagfile = /tmp/CMT_$(highlandCore_tag).make$(cmt_lock_pid)
else
#cmt_local_tagfile = $(highlandCore_tag).make
cmt_local_tagfile = $(bin)$(highlandCore_tag).make
endif
...
ifdef READONLY
cmt_local_setup = /tmp/CMT_highlandCoresetup$(cmt_lock_pid).make
cmt_final_setup = /tmp/CMT_highlandCoresetup.make
else
#cmt_local_setup = $(bin)highlandCoresetup$(cmt_lock_pid).make
...
ifdef READONLY
cmt_local_tagfile_doxygen = /tmp/CMT_$(highlandCore_tag)_doxygen.make$(cmt_lock_pid)
cmt_final_setup_doxygen = /tmp/CMT_highlandCore_doxygensetup.make
cmt_local_doxygen_makefile = /tmp/CMT_doxygen$(cmt_lock_pid).make
else
#cmt_local_tagfile_doxygen = $(highlandCore_tag)_doxygen.make
cmt_local_tagfile_doxygen = $(bin)$(highlandCore_tag)_doxygen.make
cmt_final_setup_doxygen = $(bin)highlandCore_doxygensetup.make
...
ifdef READONLY
cmt_local_tagfile_doxygen = /tmp/CMT_$(highlandCore_tag).make$(cmt_lock_pid)
cmt_final_setup_doxygen = /tmp/CMT_highlandCoresetup.make
cmt_local_doxygen_makefile = /tmp/CMT_doxygen$(cmt_lock_pid).make
else
#cmt_local_tagfile_doxygen = $(highlandCore_tag).make
cmt_local_tagfile_doxygen = $(bin)$(highlandCore_tag).make
cmt_final_setup_doxygen = $(bin)highlandCoresetup.make
cmt_local_doxygen_makefile = $(bin)doxygen.make
endif
...
highlandCore_extratags = -tag_add=target_highlandCore

#$(cmt_local_tagfile_highlandCore) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_highlandCore) ::
else
$(cmt_local_tagfile_highlandCore) :
endif
	$(echo) "(constituents.make) Rebuilding setup.make $(cmt_local_tagfile_highlandCore)"
	@if test -f $(cmt_local_tagfile_highlandCore); then /bin/rm -f $(cmt_local_tagfile_highlandCore); fi ; \
	  $(cmtexe) -tag=$(tags) $(highlandCore_extratags) build tag_makefile >>$(cmt_local_tagfile_highlandCore); \
	  if test -f $(cmt_final_setup_highlandCore); then /bin/rm -f $(cmt_final_setup_highlandCore); fi; \
	  $(cmtexe) -tag=$(tags) $(highlandCore_extratags) show setup >>$(cmt_final_setup_highlandCore)
	$(echo) setup.make ok
...
ifndef QUICK
$(cmt_local_highlandCore_makefile) :: $(highlandCore_dependencies) $(cmt_local_tagfile_highlandCore) build_library_links dirs
else
$(cmt_local_highlandCore_makefile) :: $(cmt_local_tagfile_highlandCore)
endif
	$(echo) "(constituents.make) Building highlandCore.make"; \
	  $(cmtexe) -tag=$(tags) $(highlandCore_extratags) build constituent_makefile -out=$(cmt_local_highlandCore_makefile) highlandCore

highlandCore :: $(highlandCore_dependencies) $(cmt_local_highlandCore_makefile)
	$(echo) "(constituents.make) Starting highlandCore"
	@$(MAKE) -f $(cmt_local_highlandCore_makefile) cmt_lock_pid=$${cmt_lock_pid} highlandCore
	$(echo) "(constituents.make) highlandCore done"

clean :: highlandCoreclean

highlandCoreclean :: $(highlandCoreclean_dependencies) ##$(cmt_local_highlandCore_makefile)
	$(echo) "(constituents.make) Starting highlandCoreclean"
	@-if test -f $(cmt_local_highlandCore_makefile); then \
	  $(MAKE) -f $(cmt_local_highlandCore_makefile) cmt_lock_pid=$${cmt_lock_pid} highlandCoreclean; \
	fi

##	  /bin/rm -f $(cmt_local_highlandCore_makefile) $(bin)highlandCore_dependencies.make

install :: highlandCoreinstall

highlandCoreinstall :: $(highlandCore_dependencies) $(cmt_local_highlandCore_makefile)
	$(echo) "(constituents.make) Starting install highlandCore"
	@-$(MAKE) -f $(cmt_local_highlandCore_makefile) cmt_lock_pid=$${cmt_lock_pid} install
	$(echo) "(constituents.make) install highlandCore done"

uninstall :: highlandCoreuninstall

highlandCoreuninstall :: $(cmt_local_highlandCore_makefile)
	$(echo) "(constituents.make) Starting uninstall highlandCore"
	@-$(MAKE) -f $(cmt_local_highlandCore_makefile) cmt_lock_pid=$${cmt_lock_pid} uninstall
	$(echo) "(constituents.make) uninstall highlandCore done"
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(highlandCore_tag)_make.make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_highlandCore_makesetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(highlandCore_tag)_make.make
cmt_local_tagfile_make = $(bin)$(highlandCore_tag)_make.make
cmt_final_setup_make = $(bin)highlandCore_makesetup.make
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(highlandCore_tag).make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_highlandCoresetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(highlandCore_tag).make
cmt_local_tagfile_make = $(bin)$(highlandCore_tag).make
cmt_final_setup_make = $(bin)highlandCoresetup.make
cmt_local_make_makefile = $(bin)make.make
endif
