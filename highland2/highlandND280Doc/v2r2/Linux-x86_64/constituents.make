...
ifdef READONLY
cmt_local_tagfile = /tmp/CMT_$(highlandND280Doc_tag).make$(cmt_lock_pid)
else
#cmt_local_tagfile = $(highlandND280Doc_tag).make
cmt_local_tagfile = $(bin)$(highlandND280Doc_tag).make
endif
...
ifdef READONLY
cmt_local_setup = /tmp/CMT_highlandND280Docsetup$(cmt_lock_pid).make
cmt_final_setup = /tmp/CMT_highlandND280Docsetup.make
else
#cmt_local_setup = $(bin)highlandND280Docsetup$(cmt_lock_pid).make
cmt_local_setup = $(bin)$(package)setup$$$$.make
#cmt_final_setup = $(bin)highlandND280Docsetup.make
...
ifdef READONLY
cmt_local_tagfile_doxygen = /tmp/CMT_$(highlandND280Doc_tag)_doxygen.make$(cmt_lock_pid)
cmt_final_setup_doxygen = /tmp/CMT_highlandND280Doc_doxygensetup.make
cmt_local_doxygen_makefile = /tmp/CMT_doxygen$(cmt_lock_pid).make
else
#cmt_local_tagfile_doxygen = $(highlandND280Doc_tag)_doxygen.make
cmt_local_tagfile_doxygen = $(bin)$(highlandND280Doc_tag)_doxygen.make
cmt_final_setup_doxygen = $(bin)highlandND280Doc_doxygensetup.make
...
ifdef READONLY
cmt_local_tagfile_doxygen = /tmp/CMT_$(highlandND280Doc_tag).make$(cmt_lock_pid)
cmt_final_setup_doxygen = /tmp/CMT_highlandND280Docsetup.make
cmt_local_doxygen_makefile = /tmp/CMT_doxygen$(cmt_lock_pid).make
else
#cmt_local_tagfile_doxygen = $(highlandND280Doc_tag).make
cmt_local_tagfile_doxygen = $(bin)$(highlandND280Doc_tag).make
cmt_final_setup_doxygen = $(bin)highlandND280Docsetup.make
cmt_local_doxygen_makefile = $(bin)doxygen.make
endif
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(highlandND280Doc_tag)_make.make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_highlandND280Doc_makesetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(highlandND280Doc_tag)_make.make
cmt_local_tagfile_make = $(bin)$(highlandND280Doc_tag)_make.make
cmt_final_setup_make = $(bin)highlandND280Doc_makesetup.make
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(highlandND280Doc_tag).make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_highlandND280Docsetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(highlandND280Doc_tag).make
cmt_local_tagfile_make = $(bin)$(highlandND280Doc_tag).make
cmt_final_setup_make = $(bin)highlandND280Docsetup.make
cmt_local_make_makefile = $(bin)make.make
endif
