...
tag=Linux-x86_64
package=highlandND280Doc
version=v2r2
PACKAGE_ROOT=$(HIGHLANDND280DOCROOT)
srcdir=../src
bin=../$(highlandND280Doc_tag)/
BIN=/physics/home/mhogan/software/t2k-software-clone/highland2/highlandND280Doc/v2r2/$(highlandND280Doc_tag)/
javabin=../classes/
mgrdir=cmt
project=software
cmt_installarea_paths= $(cmt_installarea_prefix)/$(CMTCONFIG)/bin
use_linkopts= $(cmt_installarea_linkopts)   $(highlandND280Doc_linkopts)  $(highlandDoc_linkopts) 
...
use_requirements=requirements $(CMTROOT)/mgr/requirements $(HIGHLANDDOCROOT)/cmt/requirements 
use_includes= $(ppcmd)"$(highlandDoc_root)/src" 
use_fincludes= $(use_includes)
use_stamps= $(highlandND280Doc_stamps)  $(highlandDoc_stamps) 
use_cflags=  $(highlandND280Doc_cflags)  $(highlandDoc_cflags) 
use_pp_cflags=  $(highlandND280Doc_pp_cflags)  $(highlandDoc_pp_cflags) 
use_cppflags=  $(highlandND280Doc_cppflags)  $(highlandDoc_cppflags) 
use_pp_cppflags=  $(highlandND280Doc_pp_cppflags)  $(highlandDoc_pp_cppflags) 
use_fflags=  $(highlandND280Doc_fflags)  $(highlandDoc_fflags) 
use_pp_fflags=  $(highlandND280Doc_pp_fflags)  $(highlandDoc_pp_fflags) 
use_libraries= $(highlandDoc_libraries) 
