...
register_dependencies= version  version  version  version  version  version  version  version  version  version  version  version  version  version  version  version  version  version  version  version 
tag=Linux-x86_64
package=numuCCMultiTargetAnalysis
version=v2r12
PACKAGE_ROOT=$(NUMUCCMULTITARGETANALYSISROOT)
srcdir=../src
bin=../$(numuCCMultiTargetAnalysis_tag)/
BIN=/physics/home/mhogan/software/t2k-software-clone/highland2/numuCCMultiTargetAnalysis/v2r12/$(numuCCMultiTargetAnalysis_tag)/
javabin=../classes/
mgrdir=cmt
project=software
cmt_installarea_paths= $(cmt_installarea_prefix)/$(CMTCONFIG)/bin
use_linkopts= $(cmt_installarea_linkopts)   $(numuCCMultiTargetAnalysis_linkopts)  $(numuCCMultiPiAnalysis_linkopts)  $(antiNumuCCAnalysis_linkopts)  $(numuCCAnalysis_linkopts)  $(baseTrackerAnalysis_linkopts)  $(baseAnalysis_linkopts)  $(highlandIO_linkopts)  $(highlandCorrections_linkopts)  $(psycheSystematics_linkopts)  $(psycheSelections_linkopts)  $(psycheIO_linkopts)  $(highlandUtils_linkopts)  $(psycheND280Utils_linkopts)  $(psycheUtils_linkopts)  $(highlandEventModel_linkopts)  $(psycheEventModel_linkopts)  $(highlandTools_linkopts)  $(highlandCore_linkopts)  $(psycheCore_linkopts)  $(psychePolicy_linkopts)  $(oaAnalysisReader_linkopts)  $(ROOT_linkopts)  $(MYSQL_linkopts)  $(GSL_linkopts)  $(EXTERN_linkopts) 
